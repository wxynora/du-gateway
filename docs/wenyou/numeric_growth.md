...
- 首次标准通关新手副本后，后端根据玩家行动倾向、角色特质和结算记录生成 1 个核心能力。
...
| 行动倾向 | 关键词例子 | 优先原型 |
| --- | --- | --- |
| 观察、检查、分析、验证线索 | 观察、检查、记录、推理、搜索 | 异常余光 |
| 逃跑、潜行、绕路、撤退 | 逃、跑、躲、潜行、撤退 | 退路直觉 |
| 救人、保护、治疗、掩护 | 保护、挡、救、治疗、包扎 | 代偿护手 |
| 攻击、破坏、硬闯、压制 | 打、砸、攻击、破坏、压制 | 破局冲击 |
| 交涉、伪装、套话、说服 | 交谈、询问、说服、伪装 | 人群伪装 |
| 规则、禁忌、广播、门牌 | 规则、禁忌、试探、条件 | 规则嗅觉 |
| 受伤、污染、濒死、坚持 | 受伤、污染、濒死、坚持 | 残响锚点 |
