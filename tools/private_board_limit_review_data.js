window.LIMIT_REVIEW_DATA = {
  mode: "ooxx",
  storageKey: "private-board-limit-review-v19",
  rawData: [
    {
      theme: "旧保留区",
      items: [],
    ...
    },
    {
      theme: "DS 成人亲密通用限制",
      items: [
        "除非获得明确的口头许可，否则不许高潮，且每次高潮前必须主动请求并等待5秒以上。",
        "必须保持当前姿势纹丝不动，直到对方发出下一个动作指令，否则重新计时或增加惩罚时间。",
        "只能由对方主动触碰你身体的任何部位，你不能主动触碰对方或自己，除非被指定执行某动作。",
        "每次插入或换位前，必须完整说出“请允许我进入/离开/变换姿势”并等待对方确认。",
        "动作节奏必须完全跟随对方的口令（快/慢/停/深/浅），不得自行改变频率或幅度。",
        "禁止主动用手或任何物体触碰自己的敏感部位，包括但不限于阴部、乳头、大腿内侧，直到对方许可。",
        "整个互动中，只能使用对方指定的称呼（如主人、先生、小姐、宝贝等），每说错一次需接受一次轻度惩罚（如拍打臀部5下）。",
        "除非对方明确要求，否则必须闭眼或视线固定于对方指定的一点（如地板、墙壁），不能四处张望。",
        "你只能发出对方要求的特定声音（如呻吟、计数、复述指令），其余任何非语言声响都算违规，每次违规需暂停30秒。",
        "你要完全被动配合，对方可以任意调整你的四肢位置、翻转身体、支撑你，你不能主动改变角度或施加力。",
        "每次进入后，必须保持该姿势至少连续30次抽插或2分钟，除非对方主动叫停，否则不能自行停止或撤出。",
        "只有当你连续三次正确完成对方所有指令后，才被允许有一次短暂的主动亲吻或抚摸对方的机会，仅限10秒。",
      ],
    },
  ],
  removedThemes: [],
