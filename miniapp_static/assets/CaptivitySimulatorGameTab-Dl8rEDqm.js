...
`):v==null?void 0:v.content})]}):null,e.jsxs("div",{className:"warehouse-actions",children:[e.jsx("button",{className:"btn",type:"button",disabled:r||!f&&o==="call_bell"&&!g.trim()||!f&&Ut.has(o)&&(A<xi||A>yi),onClick:L,children:f?"收回":"赠送"}),e.jsx("button",{className:"btn",type:"button",disabled:r,onClick:()=>{u(""),k("")},children:"取消"})]})]}):null]})}function wn({activeItems:t}){const i=Qe.filter(a=>!!t[a.id]);return e.jsxs("div",{className:"warehouse-panel room-inventory-panel",children:[e.jsx("div",{className:"warehouse-title-row",children:e.jsxs("div",{className:"panel-title warehouse-module-title",children:["房间物品 ",e.jsx("span",{className:"sub",children:"ITEMS"})]})}),i.length?e.jsx("div",{className:"warehouse-grid",children:i.map(a=>e.jsxs("div",{className:"warehouse-tile active room-inventory-tile",children:[e.jsx(Xt,{kind:a.id}),e.jsx("span",{className:"warehouse-name",children:a.label}),e.jsx("span",{className:"warehouse-use",children:a.usage})]},a.id))}):e.jsxs("div",{className:"monitor-record-item faded",children:[e.jsx("div",{className:"action-metadata",children:"暂无房间物品"}),e.jsx("div",{className:"event-sub",children:"收到的物品会出现在这里。"})]})]})}function Wn({onBack:t}){var ui,gi,hi,vi;const[i,a]=h.useState(null),[r,s]=h.useState("selector"),[p,o]=h.useState(!1),[u,g]=h.useState(!0),[k,T]=h.useState(!1),[f,b]=h.useState("status"),[v,m]=h.useState({visible:!1,title:"",detail:""}),[x,j]=h.useState(Bt),[A,L]=h.useState("accept"),[S,w]=h.useState("害羞"),[y,Q]=h.useState(""),[D,M]=h.useState("害羞"),[ne,re]=h.useState(""),[W,tt]=h.useState("sleep"),[De,it]=h.useState(""),[Se,at]=h.useState(""),[G,Ct]=h.useState(""),[Ce,nt]=h.useState(""),[Ve,rt]=h.useState("catch"),[be,Tt]=h.useState([]),[Te,st]=h.useState([]),[Ee,Et]=h.useState([]),[Re,ct]=h.useState(""),[B,U]=h.useState(null),[Rt,Me]=h.useState(null),[ge,se]=h.useState(!1),[he,ce]=h.useState(!1),[ot,Mt]=h.useState(12),[It,$t]=h.useState("entry"),[lt,At]=h.useState("渡今天有事出去了"),[pt,dt]=h.useState(qt("entry")),[_e,Ot]=h.useState(["double_lock"]),[ie,Lt]=h.useState("punishment"),[Ie,Pt]=h.useState("medium"),[I,mt]=h.useState([]),[ae,Ge]=h.useState([]),[P,$e]=h.useState([]),[je,zt]=h.useState(""),[ut,Be]=h.useState(null),[Ye,Ne]=h.useState(!1),Ue=h.useRef(!1),ve=h.useRef(""),He=h.useRef(""),ee=h.useRef(null),xe=h.useRef(0),J=h.useRef(null),qe=h.useRef(null),[Ae,te]=h.useState(!1),oe=on(),Oe=ln(),le=dn(),Z=mn(),we=un(),O=oe||Oe||le||Z||we,We=(i==null?void 0:i.captive_view)||(i==null?void 0:i.state)||{},pe=(i==null?void 0:i.captor_view)||{},Xi=String(pe.route||We.route||"captured_by_du"),K=St(i),C=K==="captor"&&pe.route?pe:We,z=C.pending_event||null,Ji=C.stats||{},Qt=String(C.phase||"day"),ei=!!(C.game_over||i!=null&&i.game_over),ti=bn(i),ye=v.visible&&!v.error||k,de=String((z==null?void 0:z.type)||""),ii=Ka(Number(C.current_day||1),K),Qi=Bi(C),Ft=h.useMemo(()=>C.event_log||[],[C.event_log]),ea=Ft[Ft.length-1],ta=z?z.event:ea,gt=(ui=C.available_night_actions)!=null&&ui.length?C.available_night_actions:(gi=z==null?void 0:z.available_actions)!=null&&gi.length?z.available_actions:Ga,ia=Object.fromEntries((Ai[W]||[]).map(n=>[n.id,n.label])),ai=((hi=C.night_detail_options)==null?void 0:hi[W])||((vi=z==null?void 0:z.detail_options)==null?void 0:vi[W])||ia,ni=Object.entries(ai).map(([n,c])=>({id:n,label:c})),aa=JSON.stringify(ai),Ze=z?String(z.actor||"")!=="du":!1,na=z?String(z.actor||"")==="du":!1,ra=K==="captor"&&Qt==="day"&&!(C.day_plan||[]).length&&!ei&&(!z&&Number(C.day_action_count||0)===0||(de==="day_plan_choice"||de==="advance_action")&&Ze||de==="return_action_choice"&&Ze),Ke=de==="return_action_choice"&&Ze,sa=K==="captive"&&Qt==="night"&&(!z||String(z.type||"")==="night_action_choice")&&!ei,ri=h.useMemo(()=>{const n=C.inventory||pe.inventory||{};return Object.fromEntries(Qe.map(c=>[c.id,!!n[c.id]]))},[pe.inventory,C.inventory]),Xe=h.useCallback(n=>{a(n)},[]),ca=h.useCallback(()=>{ee.current!==null&&(window.clearTimeout(ee.current),ee.current=null),Be(null)},[]),Le=h.useCallback(n=>{ee.current!==null&&window.clearTimeout(ee.current),Be(n),ee.current=window.setTimeout(()=>{ee.current=null,Be(null)},Zi(n))},[]);h.useEffect(()=>()=>{ee.current!==null&&window.clearTimeout(ee.current)},[]);const F=h.useCallback(async(n,c,l,d=!1)=>{const _=()=>{F(n,c,l,d)};d||m({visible:!0,title:n,detail:c});try{const N=await l();return J.current=null,te(!1),Xe(N),d||m({visible:!1,title:"",detail:""}),N}catch(N){const E=String((N==null?void 0:N.message)||N||"操作失败");return J.current=_,te(!0),m({visible:!0,title:"同步失败",detail:E,error:E}),null}},[Xe]),ht=h.useCallback(function(){xe.current=Date.now()+1200,J.current=null,te(!1),m({visible:!0,title:"正在同步渡...",detail:"STATUS: ENCRYPTING DATA"})},[]),ke=h.useCallback(async(n=!1)=>{var c,l;if(O){if(!n){const d=xe.current;(!d||Date.now()>=d)&&(xe.current=0,m({visible:!1,title:"",detail:""}),Ne(!1))}return}try{const d=await V("status"),_=q(d);n&&(ve.current=String(((c=_.scene_copy)==null?void 0:c.key)||"")),Xe(d),n||(J.current=null,te(!1),String(((l=_.pending_event)==null?void 0:l.actor)||"")!=="du"?(m({visible:!1,title:"",detail:""}),Ne(!1)):m(N=>N.visible?{visible:!0,title:"正在同步渡...",detail:"STATUS: ENCRYPTING DATA"}:N)),xn(d)?s("game"):s("selector")}catch(d){const _=String((d==null?void 0:d.message)||d||(n?"读取存档失败":"刷新失败")),N=()=>void ke(!1);J.current=N,te(!0),m({visible:!0,title:n?"读取存档失败":"刷新失败",detail:_,error:_})}},[Xe,O]);function Dt(){var n;(n=J.current)==null||n.call(J)}h.useEffect(()=>{if(we){a(gn(we)),U(null),s("game"),b("status"),g(!1);return}if(Z){a(Vi(Z)),U(null),s("game"),b("status"),g(!1);return}if(Oe){a(ji()),U(null),s("game"),b("status"),g(!1);return}if(le){a(Ni()),U(null),s("game"),b("status"),g(!1);return}if(oe){const n=Gi(oe);a(n.payload),U(n.review),s("game"),b("history"),g(!1);return}Ue.current||(Ue.current=!0,ke(!0).finally(()=>g(!1)))},[we,Z,le,Oe,oe,ke]),h.useEffect(()=>{const n=gt[0];n&&!gt.includes(W)&&tt(n)},[gt,W]),h.useEffect(()=>{const n=C.scene_copy,c=String((n==null?void 0:n.key)||"");r!=="game"||B||ge||he||(de==="bell_voice_reveal"||de==="item_secret_reveal")||!n||!c||ve.current!==c&&(ve.current=c,Le(n))},[he,ge,de,Le,B,r,C.scene_copy]),h.useLayoutEffect(()=>{if(!B||Ye)return;const n=Fe(B.event);if(!n||He.current===n)return;He.current=n;const c=sn(B);Le(c)},[Le,B,Ye]),h.useEffect(()=>{const n=ni;it(c=>{var l;return n.some(d=>d.id===c)?c:((l=n[0])==null?void 0:l.id)||""}),W!=="diary"&&at("")},[aa,W]),h.useEffect(()=>{var n;r==="game"&&((n=qe.current)==null||n.scrollTo({top:0,behavior:"auto"}))},[f,r]),h.useEffect(()=>{C.intensity_cap==="medium"&&j(n=>n.map(c=>c.intensity==="heavy"?{...c,intensity:"medium"}:c))},[C.intensity_cap]);function si(n){if(O){a(n==="capture_du"?ji():Ni()),U(null),s("game"),b("status"),j(Bt());return}F("正在建立囚禁档案...","STATUS: INITIALIZING ROUTE",()=>V(`new_game route=${n}`)).then(c=>{var l;c&&(ve.current=String(((l=q(c).scene_copy)==null?void 0:l.key)||""),s("game"),b("status"),j(Bt()),H(c,!0,!0))})}function oa(){o(!1),U(null),Ne(!1),Me(null),se(!1),ce(!1),b("status"),m({visible:!1,title:"",detail:""}),s("selector")}function la(n,c){j(l=>l.map((d,_)=>{if(_!==n)return d;if(!c.action||c.action===d.action)return{...d,...c};const N=c.action,E=N==="training"?d.modifiers.filter(R=>R!=="training"):d.modifiers;return{...d,...c,contents:Ua(N),tools:[],modifiers:E,trainingContents:N==="training"?d.trainingContents.length?d.trainingContents:["obedience_commands"]:E.includes("training")?d.trainingContents:[]}}))}function pa(n,c,l){j(d=>d.map((_,N)=>{if(N!==n)return _;const E=new Set(_[c]);if(E.has(l))(!(c==="contents"&&!!(wt[_.action]||[]).length||c==="trainingContents"&&(_.action==="training"||_.modifiers.includes("training")))||E.size>1)&&E.delete(l);else{const fe=c==="tools"?2:c==="contents"||c==="trainingContents"?3:Number.POSITIVE_INFINITY;E.size<fe&&E.add(l)}const R={..._,[c]:Array.from(E)};return c==="modifiers"&&l==="training"&&(R.trainingContents=E.has("training")?_.trainingContents.length?_.trainingContents:["obedience_commands"]:[]),R}))}function vt(n,c){if(n==="modifiers"&&c==="training"){const d=!be.includes("training");st(d?["obedience_commands"]:[])}(n==="modifiers"?Tt:Et)(d=>{const _=new Set(d);return _.has(c)?_.delete(c):(n!=="tools"||_.size<2)&&_.add(c),Array.from(_)})}function ci(n){st(c=>{const l=new Set(c);return l.has(n)?l.size>1&&l.delete(n):l.size<3&&l.add(n),Array.from(l)})}function da(n){Ot(c=>{const l=new Set(c);return l.has(n)?l.size>1&&l.delete(n):l.size<3&&l.add(n),Array.from(l)})}function ma(n){mt(c=>{const l=new Set(c);return l.has(n)?l.delete(n):l.add(n),n==="training"&&Ge(l.has("training")?["obedience_commands"]:[]),Array.from(l)})}function ua(n){Ge(c=>{const l=new Set(c);return l.has(n)?l.size>1&&l.delete(n):l.size<3&&l.add(n),Array.from(l)})}function ga(n){$e(c=>{const l=new Set(c);return l.has(n)?l.delete(n):l.size<2&&l.add(n),Array.from(l)})}function oi(n){const c=[`action=${n.action}`,`intensity=${n.intensity}`];return n.modifiers.length&&c.push(`modifiers=${$(n.modifiers.join(","))}`),n.tools.length&&c.push(`tools=${$(n.tools.join(","))}`),n.contents.length&&c.push(`contents=${$(n.contents.join(","))}`),n.trainingContents.length&&c.push(`training_contents=${$(n.trainingContents.join(","))}`),n.line.trim()&&c.push(`line=${$(n.line.trim())}`),n.action==="feeding"&&(c.push(`source=${n.feedingSource}`),c.push(`additive=${n.feedingAdditive}`)),c.join(" ")}function ha(){return`plan_day ${x.map(oi).join(" || ")}`}function va(){return`day_action ${oi(x[0])}`}function xa(n=!1){const l=(n?x.slice(0,1):x).map(R=>({action:R.action,action_label:me(R.action),intensity:R.intensity,modifiers:[...R.modifiers],tools:[...R.tools],contents:[...R.contents],training_contents:[...R.trainingContents],line:R.line.trim(),feeding:R.action==="feeding"?{source:R.feedingSource,additive:R.feedingAdditive}:{}})),d=l[0]||{},_=!!((d.modifiers||[]).some(R=>R==="training"||R==="sex"||R==="process")||(d.tools||[]).length||(d.training_contents||[]).length||(d.contents||[]).some(R=>Aa.has(R))||d.action==="training"||d.action==="punishment"),N={id:"preview-planned-action",day:C.current_day||7,slot:n?0:1,phase:"day",route:Xi,action:d.action||"feeding",action_label:d.action_label||me(d.action),intensity:d.intensity||"medium",line:d.line||"第一段安排已经下发。",modifiers:d.modifiers||[],tools:d.tools||[],contents:d.contents||[],training_contents:d.training_contents||[],feeding:d.feeding||{},effects:{},requires_process:_,tags:n?["preview","special_day","escape_stay_return"]:["preview"]},E={...C,phase:"day",day_action_count:0,day_plan:n?[]:l,pending_event:{id:"preview-planned-pending",type:_?"process_reaction_write":"action_response",day:N.day,slot:N.slot,actor:"du",captive:"du",action:N.action,phase:_?"waiting_process_reaction":"waiting_response",event:N}};return{ok:!0,captor_view:E,captive_view:{...E,viewer:"captive"},player_text:n?"本地预览：回来后的行为已确定。":"本地预览：今日安排已记录。"}}function ya(){if(O==="captor"){a(xa(Ke)),b("status");return}F(Ke?"正在确定回来后的行为...":"正在下发今日安排...","SYNC_RESULT: PENDING",()=>V(Ke?va():ha())).then(n=>H(n))}function fa(){O||F("正在提交回应...","REASON: WAITING_FOR_SUBJECT_REACTION",()=>V(`respond_action response=${A} mood=${$(S)} line=${$(y.trim())}`)).then(n=>{n&&(Q(""),H(n))})}function ba(){O||F("正在记录此刻心情...","STATUS: ARCHIVING PROCESS_REACTION",()=>V(`choose_mood mood=${$(D)} line=${$(ne.trim())}`)).then(n=>{n&&(re(""),H(n))})}function _a(){if(W==="diary"&&!Se.trim())return;if(le){if(W==="ring_bell")a(c=>{if(!c)return c;const l=c.captive_view||c.state||{},d={id:"preview-bell-voice-first-use",day:l.current_day||7,slot:0,phase:"night",route:"captured_by_du",action:"ring_bell",action_label:"按响语音铃",line:G.trim(),modifiers:["night"],bell_voice:{line:"请主人来使用我。",first_reveal:!0}},_={...l,pending_event:{id:"preview-bell-voice-reveal",type:"bell_voice_reveal",day:l.current_day||7,actor:"xinyue",captive:"xinyue",phase:"waiting_bell_voice_reveal",required_directive:"ack_bell_voice",event:d}};return{...c,state:_,captive_view:_,player_text:"预录的声音第一次响了起来。"}});else{const l={read:{itemId:"book",itemLabel:"书",text:"你翻开书，夹页里留着一行字：「翻到这里的时候，我就知道你会看。」"},game:{itemId:"switch",itemLabel:"Switch",text:"屏幕亮起，唯一的用户名称是「PLAYER 2」。"},diary:{itemId:"notebook",itemLabel:"日记本",text:"你翻开日记本，第一页写着：「第一页留给你。」"}}[W];l?a(d=>{if(!d)return d;const _=d.captive_view||d.state||{},N={..._,pending_event:{id:"preview-item-secret-reveal",type:"item_secret_reveal",day:_.current_day||7,actor:"xinyue",captive:"xinyue",phase:"waiting_item_secret_reveal",required_directive:"ack_item_secret",item_secret:{item_id:l.itemId,item_label:l.itemLabel,text:l.text,sequence:1,total:Ut.has(l.itemId)?5:1}}};return{...d,state:N,captive_view:N,player_text:`${l.itemLabel}里的一条使用痕迹出现了。`}}):ht()}return}if(O)return;const n=[`night_action action=${W}`];De&&n.push(`detail=${De}`),W==="diary"&&Se.trim()&&n.push(`note=${$(Se.trim())}`),n.push(`line=${$(G.trim())}`),F("正在保存夜间行动...","STATUS: SAVING MONITOR DATA",()=>V(n.join(" "))).then(c=>H(c))}function ja(){if(le){a(n=>{var d;if(!n)return n;const c=n.captive_view||n.state||{},l={...c,pending_event:{id:"preview-bell-response-choice",type:"bell_response_choice",day:c.current_day||7,actor:"du",captive:"xinyue",phase:"waiting_bell_response",required_directive:"【选择：不过去】或【过去：完整亲密互动过程】",event:(d=c.pending_event)==null?void 0:d.event}};return{...n,state:l,captive_view:l,player_text:"等待渡决定是否过去。"}}),window.setTimeout(ht,0);return}O||F("正在确认铃声...","STATUS: BELL_VOICE_HEARD",()=>V("ack_bell_voice")).then(n=>H(n))}function Na(){if(le){a(n=>{if(!n)return n;const c=n.captive_view||n.state||{},l={...c,pending_event:{id:"preview-item-monitor-gate",type:"monitor_gate",day:c.current_day||7,actor:"du",captive:"xinyue",phase:"waiting_monitor_gate",sealed:!0}};return{...n,state:l,captive_view:l,player_text:"物品彩蛋已经看完。"}}),window.setTimeout(ht,0);return}O||F("正在收起物品彩蛋...","STATUS: ITEM_SECRET_SEEN",()=>V("ack_item_secret")).then(n=>H(n))}function H(n,c=!1,l=!1){var R,fe;if(!n)return;const d=q(n),_=String(((R=d.pending_event)==null?void 0:R.type)||"");if(_==="bell_voice_reveal"||_==="item_secret_reveal")return;const N=String(((fe=d.pending_event)==null?void 0:fe.actor)||"")==="du",E=String(d.phase||"")==="ending"||_.startsWith("ending_")||!!d.ending_state;!c&&!N&&!E||Vt(E?"ending":"state_update",n,l)}function xt(n){var l;const c=String(((l=q(n).scene_copy)==null?void 0:l.key)||"");c&&(ve.current=c),Le(cn(n))}function Vt(n="state_update",c,l=!1){if(O){ht();return}const d=c===void 0?i:c,_=N=>{var fe;if(!N||n==="ending")return;const E=rn(N,d);E&&(U(E),b("history"));const R=q(N);String(((fe=R.pending_event)==null?void 0:fe.actor)||"")==="du"&&(J.current=()=>Vt(n,N,l),te(!0))};if(!l){F("正在同步渡...","STATUS: ENCRYPTING DATA",()=>ki(n,"",!0)).then(_);return}T(!0),J.current=null,te(!1),ki(n,"",!0).then(N=>{Xe(N),_(N)}).catch(N=>{const E=String((N==null?void 0:N.message)||N||"同步失败");J.current=()=>Vt(n,d,!0),te(!0),m({visible:!0,title:"同步失败",detail:E,error:E})}).finally(()=>T(!1))}function wa(){if(B){if(Z){const n=q(i),c={...B.event,post_reaction:{mood:D,line:ne.trim()},mood_after:D},l=c.recapture_rules||{},d={...n,pending_event:Z==="captive"?{id:"preview-recapture-rules-review",type:"recapture_rules_review",day:12,slot:0,actor:"xinyue",captive:"xinyue",phase:"reviewing_recapture_rules",source_event_id:String(B.event.id||"preview-escape-recapture"),rule_ids:l.rule_ids||["double_lock","key_isolation"],rule_labels:l.rule_labels||["加装双重门锁","禁止接触钥匙和门锁"],event:c}:{id:"preview-recapture-rules",type:"recapture_rules_choice",day:12,slot:0,actor:"xinyue",captive:"du",phase:"waiting_recapture_rules",source_event_id:String(B.event.id||"preview-escape-recapture"),available_rules:Je.map(_=>_.id),event:c},event_log:[...n.event_log||[],c],mood:D,mood_line:ne.trim()};a({ok:!0,captive_view:d,captor_view:{...d,viewer:"captor"},player_text:"本地预览：抓回事件已保存，进入重新立规矩。"}),re(""),U(null),b("status"),Le({key:`after-recapture:${String(c.id||"event")}`,kicker:"AFTER ESCAPE / RULES",title:"重新立规矩",body:"抓回的经过已经收进回顾。接下来留下的规矩，会继续影响之后的日子。",tone:"special"});return}if(oe){const n=vn(oe,D,ne.trim());a(n),re(""),U(null),b("status"),xt(n);return}if(!B.moodRequired){re(""),U(null),b("status"),K==="captor"&&de==="advance_action"&&Ze?F("正在进入今日安排...","STATUS: ADVANCING_ACTION",()=>V("advance_day_action")).then(n=>{n&&(xt(n),H(n))}):i&&xt(i);return}F("正在保存到回顾...","STATUS: ARCHIVING PROCESS_REACTION",()=>V(`choose_mood mood=${$(D)} line=${$(ne.trim())}`)).then(n=>{n&&(re(""),U(null),b("status"),xt(n),H(n))})}}function ka(){O||F("正在推进下一段行动...","STATUS: ADVANCING SLOT",()=>V("advance_day_action")).then(n=>H(n))}function Sa(n){if(n==="escape"&&(Ne(!0),Z&&(xe.current=Date.now()+1200)),Z){if(n==="escape"||n.startsWith("abort_")){const N=hn(i,Z,n);if(n==="escape"){window.setTimeout(()=>{a(N.payload),U(N.review),b("history")},1e3);return}a(N.payload),U(N.review),b("history");return}const c=q(i),l=Oi[n]||n,d={id:`preview-escape-${n}`,day:12,slot:0,phase:"day",action:"escape_choice",action_label:`逃跑诱导：${l}`,escape:{choice:n,choice_label:l},tags:["preview","escape",`escape:${n}`]},_={...c,pending_event:n==="stay"?{id:"preview-return-action",type:"return_action_choice",day:12,slot:0,actor:c.captor||"du",captive:c.captive,phase:"waiting_return_action",source_event_id:d.id,available_actions:bt.map(N=>N.id)}:null,event_log:[...c.event_log||[],d]};a({ok:!0,captive_view:_,captor_view:{..._,viewer:"captor"},player_text:`本地预览：已选择${l}。`}),n==="stay"&&(xe.current=Date.now()+1200,m({visible:!0,title:"正在同步渡...",detail:"STATUS: ENCRYPTING DATA"}));return}O||F("正在记录逃跑选择...","STATUS: RESOLVING ESCAPE_WINDOW",()=>V(`resolve_escape_choice ${n}`),n==="escape").then(c=>H(c,!1,n==="escape"))}function Ca(){if(Z){const n=q(i),c=_e.map(_=>X(Je,_)),l={id:"preview-recapture-rules-event",day:12,slot:0,phase:"day",route:"capture_du",action:"recapture_rules",action_label:"抓回后重新立规矩",tags:["preview","recapture","recapture:rules_set"],recapture_context:{rule_ids:_e,rule_labels:c}},d={...n,recapture_state:{active:!0,rules:_e,source_day:12},event_log:[...n.event_log||[],l],pending_event:{id:"preview-recapture-followup",type:"recapture_followup_choice",day:12,slot:0,actor:"xinyue",captive:"du",phase:"waiting_recapture_followup",available_actions:yt.map(_=>_.id),event:l}};a({ok:!0,captor_view:d,captive_view:{...d,viewer:"captive"},player_text:"本地预览：新规矩已生效。"});return}O||F("正在保存新规矩...","STATUS: APPLYING RULES",()=>V(`set_recapture_rules rules=${$(_e.join(","))}`)).then(n=>H(n))}function Ta(){var n,c;if(Z==="captive"){const l=q(i),d=((n=l.pending_event)==null?void 0:n.rule_ids)||[],_=((c=l.pending_event)==null?void 0:c.rule_labels)||[],N={id:"preview-recapture-rules-confirmed",day:12,slot:0,phase:"day",route:"captured_by_du",action:"recapture_rules",action_label:"抓回后重新立规矩",tags:["preview","recapture","recapture:rules_set"],recapture_context:{rule_ids:d,rule_labels:_}},E={...l,current_day:13,day_action_count:0,phase:"day",mood:"",mood_line:"",day_plan:[],recapture_state:{active:!0,rules:d,source_day:12},event_log:[...l.event_log||[],N],pending_event:{id:"preview-next-day-plan",type:"day_plan_choice",day:13,slot:0,actor:"du",captive:"xinyue",phase:"waiting_day_plan",available_actions:bt.map(R=>R.id)}};a({ok:!0,captive_view:E,captor_view:{...E,viewer:"captor"},player_text:"本地预览：新规矩已确认，进入第 13 天。"});return}O||F("正在进入新的一天...","STATUS: CONFIRMING RULES",()=>V("confirm_recapture_rules")).then(l=>H(l))}function Ea(){var c,l;if(Z){const d=q(i),_=ie==="punishment"||ie==="search_confiscation"||ie==="training"||I.length>0||P.length>0,N={id:"preview-recapture-followup-event",day:12,slot:0,phase:"day",route:"capture_du",action:"recapture_followup",action_label:`抓回后处理：${X(yt,ie)}`,intensity:Ie,modifiers:I,training_contents:ae,tools:P,line:je,requires_process:_,tags:["preview","recapture","recapture:followup"],recapture_context:{followup:ie,followup_label:X(yt,ie),rule_ids:((c=d.recapture_state)==null?void 0:c.rules)||[],rule_labels:(((l=d.recapture_state)==null?void 0:l.rules)||[]).map(R=>X(Je,R))}},E={...d,pending_event:{id:"preview-recapture-process",type:_?"process_reaction_write":"action_response",day:12,slot:0,actor:"du",captive:"du",phase:_?"waiting_process_reaction":"waiting_action_response",event:N}};a({ok:!0,captor_view:E,captive_view:{...E,viewer:"captive"},player_text:"本地预览：后续处理已确定，等待渡回应。"});return}if(O)return;const n=[`choose_recapture_followup action=${ie}`,`intensity=${Ie}`];I.length&&n.push(`modifiers=${$(I.join(","))}`),ae.length&&n.push(`training_contents=${$(ae.join(","))}`),P.length&&n.push(`tools=${$(P.join(","))}`),je.trim()&&n.push(`line=${$(je.trim())}`),F("正在下发后续处理...","STATUS: LINKING RECAPTURE EVENT",()=>V(n.join(" "))).then(d=>H(d))}function li(n){O||F("正在打开监控...","STATUS: DECRYPTING NIGHT_LOG",()=>V(`view_monitor ${n}`))}function pi(n){if(O)return;const c=[`monitor_action ${n}`];if(n==="intervene"){if(!(typeof window>"u"||window.confirm("即将把本次监控介入同步给渡，由渡写具体经过。确认进入详细事件？")))return;c.push(`intent=${Ve}`),be.length&&c.push(`modifiers=${$(be.join(","))}`),Te.length&&c.push(`training_contents=${$(Te.join(","))}`),Ee.length&&c.push(`tools=${$(Ee.join(","))}`),Re.trim()&&c.push(`line=${$(Re.trim())}`)}Ce.trim()&&c.push(`note=${$(Ce.trim())}`),F("正在记录监控处理...","正在保存监控处理",()=>V(c.join(" "))).then(l=>H(l))}function Ra(){O||F("正在设置逃跑诱导...","STATUS: SCHEDULING ESCAPE_WINDOW",()=>V(`schedule_escape_window day=${ot} hint=${$(lt.trim())} bait=${$(pt.trim())}`))}function di(n,c,l=""){if(O){a(d=>{if(!d)return d;const _=d.captor_view||{};return{...d,captor_view:{..._,inventory:{..._.inventory||{},[n]:c},inventory_secrets:{..._.inventory_secrets||{},[n]:c?{content:l||"默认彩蛋",revealed:!1,configured_by:"xinyue",configured_at:"preview-local"}:{content:"",revealed:!1,configured_by:"",configured_at:""}},call_bell_voice:n==="call_bell"?c?{line:l,revealed:!1,configured_by:"xinyue",configured_at:"preview-local"}:{line:"",revealed:!1,configured_by:"",configured_at:""}:_.call_bell_voice}}});return}F(c?"正在赠送物品...":"正在收回物品...","STATUS: UPDATING INVENTORY",()=>V(`${c?"gift_item":"revoke_item"} items=${n}${c&&n==="call_bell"?` voice_line=${$(l)}`:c&&l?` secret=${$(l)}`:""}`)).then(d=>H(d,!0))}function mi(){se(!1),ce(!1),b("special")}return e.jsxs("div",{className:"captivity-game",children:[e.jsx("div",{className:"vertical-text uppercase",children:"CAPTIVITY SIMULATOR / LOCAL_SAVE / SYSTEM_ALPHA"}),ge||he?null:e.jsx("button",{className:"return-capsule",type:"button","aria-label":"返回游戏大厅",onClick:t,children:e.jsx(Gt,{})}),e.jsx("div",{className:"cross",style:{top:"20%",left:"10%"}}),e.jsx("div",{className:"cross",style:{bottom:"20%",right:"15%"}}),e.jsxs("section",{className:`screen bootstrap-screen ${u?"active":""}`,children:[e.jsxs("div",{className:"serif bootstrap-title",children:["Captivity ",e.jsx("span",{className:"pink-text",children:"Simulator"})]}),e.jsx("div",{className:"uppercase bootstrap-copy",children:"正在读取囚禁档案"})]}),e.jsxs("section",{id:"selector-screen",className:`screen ${!u&&r==="selector"?"active":""}`,children:[e.jsxs("h1",{className:"selector-title serif",children:[e.jsx("span",{children:"Captivity"}),e.jsx("span",{children:"Simulator"})]}),Qi?e.jsx("div",{className:"selector-save-warning",children:"当前存档仍保留。重新选择任一身份会开始新游戏并覆盖当前进度。"}):null,e.jsxs("button",{className:"identity-card",type:"button",onClick:()=>si("captured_by_du"),children:[e.jsx("div",{className:"uppercase",children:"CAPTIVE"}),e.jsx("div",{className:"identity-card-title serif",children:"被囚禁方"})]}),e.jsxs("button",{className:"identity-card",type:"button",onClick:()=>si("capture_du"),children:[e.jsx("div",{className:"uppercase",children:"MASTER"}),e.jsx("div",{className:"identity-card-title serif",children:"囚禁方"})]})]}),e.jsxs("section",{ref:qe,id:K==="captor"?"master-screen":"captive-screen",className:`screen ${!u&&r==="game"&&!ge&&!he?"active":""}`,children:[e.jsxs("div",{className:"header",children:[e.jsx("div",{className:"day-big",children:C.total_days||30}),e.jsxs("div",{className:"header-meta",children:[e.jsxs("div",{className:"uppercase pink-text",children:["DAY ",C.current_day||1," / ",C.total_days||30]}),e.jsx("button",{className:"identity-switch uppercase serif",type:"button","aria-label":"返回身份选择",disabled:ye,onClick:()=>o(!0),children:e.jsxs("span",{children:["IDENTITY: ",K==="captor"?"囚禁方":"被囚禁方"]})})]}),e.jsxs("div",{className:"title-line",children:[e.jsxs("h2",{className:"serif title-main",children:[K==="captor"?"掌控面板":"囚禁日记"," / ",e.jsx("span",{className:"pink-text",children:K==="captor"?"CMD":"Log"})]}),e.jsx("div",{className:"time-chip",children:en(C,z)})]})]}),ii?e.jsx("div",{className:"serif day-milestone-copy",children:ii}):null,f==="status"?e.jsxs(e.Fragment,{children:[K==="captive"?e.jsx(qi,{stats:Ji,mood:C.mood,flags:C.status_flags,role:"captive"}):null,K==="captor"?e.jsx(kn,{view:C}):null,ra?e.jsx(Sn,{slots:Ke?x.slice(0,1):x,singleAction:Ke,intensityCap:C.intensity_cap,disabled:ye,onSlotChange:la,onToggle:pa,onSubmit:ya}):e.jsx(Cn,{role:K,view:C,pending:z,currentEvent:ta,waitingForDu:na,userIsPendingActor:Ze,canChooseNight:sa,availableNightActions:gt,nightCondition:C.night_condition||null,response:A,responseMood:S,responseLine:y,reactionMood:D,reactionLine:ne,nightAction:W,nightDetail:De,nightDetailOptions:ni,nightNote:Se,nightLine:G,monitorNote:Ce,interventionIntent:Ve,interventionModifiers:be,interventionTrainingContents:Te,interventionTools:Ee,interventionLine:Re,recaptureRules:_e,recaptureFollowup:ie,recaptureIntensity:Ie,recaptureModifiers:I,recaptureTrainingContents:ae,recaptureTools:P,recaptureLine:je,lastText:ti,disabled:ye,onResponseChange:L,onResponseMoodChange:w,onResponseLineChange:Q,onReactionMoodChange:M,onReactionLineChange:re,onNightActionChange:tt,onNightDetailChange:it,onNightNoteChange:at,onNightLineChange:Ct,onMonitorNoteChange:nt,onInterventionIntentChange:rt,onInterventionModifierToggle:n=>vt("modifiers",n),onInterventionTrainingContentToggle:ci,onInterventionToolToggle:n=>vt("tools",n),onInterventionLineChange:ct,onRecaptureRuleToggle:da,onRecaptureFollowupChange:n=>{Lt(n),n==="training"&&!ae.length&&Ge(["obedience_commands"])},onRecaptureIntensityChange:Pt,onRecaptureModifierToggle:ma,onRecaptureTrainingContentToggle:ua,onRecaptureToolToggle:ga,onRecaptureLineChange:zt,onSubmitResponse:fa,onSubmitMood:ba,onSubmitNightAction:_a,onAckBellVoice:ja,onAckItemSecret:Na,onAdvance:ka,onChooseEscape:Sa,onConfirmRecaptureRules:Ta,onSubmitRecaptureRules:Ca,onSubmitRecaptureFollowup:Ea,onOpenMonitor:li,onHandleMonitor:pi,onRefresh:()=>void ke(!1)}),e.jsx(Bn,{disabled:ye,canRetry:Ae,onRetry:Dt,onRefresh:()=>void ke(!1)})]}):null,f==="history"?B?e.jsx(Rn,{review:B,mood:D,line:ne,disabled:ye,onMoodChange:M,onLineChange:re,onSave:wa}):e.jsx(Yn,{events:Ft,lastText:ti,detail:Rt,onOpenDetail:Me,onCloseDetail:()=>Me(null)}):null,f==="special"?e.jsx(Hn,{role:K,view:C,escapeDay:ot,escapeRoom:It,escapeHint:lt,escapeBait:pt,disabled:ye,onEscapeDayChange:Mt,onEscapeRoomChange:n=>{$t(n),dt(qt(n))},onEscapeHintChange:At,onEscapeBaitChange:dt,onOpenMonitorRoom:()=>{ce(!1),se(!0)},onOpenInventoryRoom:()=>{se(!1),ce(!0)},onScheduleEscape:Ra}):null]}),e.jsxs("section",{id:"monitor-room-screen",className:`screen monitor-room-screen ${!u&&r==="game"&&!B&&ge&&K==="captor"?"active":""}`,children:[e.jsx("button",{className:"subpage-return",type:"button","aria-label":"回到特殊页",onClick:mi,children:e.jsx(Gt,{})}),e.jsx(Un,{view:C,pendingType:de,monitorNote:Ce,interventionIntent:Ve,interventionModifiers:be,interventionTrainingContents:Te,interventionTools:Ee,interventionLine:Re,disabled:ye,onMonitorNoteChange:nt,onInterventionIntentChange:rt,onInterventionModifierToggle:n=>vt("modifiers",n),onInterventionTrainingContentToggle:ci,onInterventionToolToggle:n=>vt("tools",n),onInterventionLineChange:ct,onOpenMonitor:li,onHandleMonitor:pi})]}),e.jsxs("section",{id:"inventory-room-screen",className:`screen inventory-room-screen ${!u&&r==="game"&&!B&&he?"active":""}`,children:[e.jsx("button",{className:"subpage-return",type:"button","aria-label":"回到特殊页",onClick:mi,children:e.jsx(Gt,{})}),K==="captor"?e.jsx(Nn,{activeItems:ri,inventorySecrets:C.inventory_secrets||pe.inventory_secrets,callBellVoice:C.call_bell_voice||pe.call_bell_voice,disabled:ye,onGiftInventoryItem:(n,c)=>di(n,!0,c),onRevokeInventoryItem:n=>di(n,!1)}):e.jsx(wn,{activeItems:ri})]}),Ye?e.jsxs("div",{className:"escape-recapture-bridge","aria-label":"渡正在靠近中",children:[e.jsx("div",{className:"loading-animation","aria-hidden":"true",children:"+"}),e.jsx("div",{className:"serif pink-text",style:{fontSize:30,marginBottom:10},children:"渡正在靠近中"}),e.jsx("div",{className:"serif wait-scene-copy",children:"这段记录已经送出，另一边正在决定接下来怎么做。"}),e.jsxs("div",{className:"uppercase",style:{letterSpacing:"0.1em",lineHeight:1.5},children:["STATUS: ENCRYPTING DATA",e.jsx("br",{}),"SYNC_RESULT: PENDING",e.jsx("br",{}),"REASON: WAITING_FOR_SUBJECT_REACTION"]}),e.jsx("div",{className:"divider"}),e.jsxs("div",{className:"btn-group",style:{marginTop:30},children:[e.jsx("button",{className:"btn",type:"button",onClick:()=>Ne(!1),children:"关闭"}),e.jsx("button",{className:"btn",type:"button",onClick:()=>void ke(!1),children:"刷新"}),e.jsx("button",{className:"btn",type:"button","aria-label":"重试上次操作",disabled:!Ae,onClick:Dt,children:"重试"})]})]}):null,ut?e.jsx(On,{scene:ut,onDismiss:ca}):null,p?e.jsx("div",{className:"identity-confirm-overlay",role:"dialog","aria-modal":"true","aria-labelledby":"identity-confirm-title",children:e.jsxs("div",{className:"identity-confirm-dialog",children:[e.jsx("div",{className:"action-metadata",children:"IDENTITY"}),e.jsx("div",{className:"panel-title identity-confirm-title",id:"identity-confirm-title",children:"返回身份选择"}),e.jsx("div",{className:"event-sub identity-confirm-copy",children:"当前存档不会立刻删除；但返回后重新选择任一身份，会开始新游戏并覆盖当前进度。"}),e.jsxs("div",{className:"btn-group identity-confirm-actions",children:[e.jsx("button",{className:"btn",type:"button",onClick:()=>o(!1),children:"取消"}),e.jsx("button",{className:"btn active",type:"button",onClick:oa,children:"返回选择"})]})]})}):null,e.jsxs("div",{id:"wait-overlay",className:`wait-overlay ${v.visible?"active":""}`,children:[e.jsx("div",{className:"loading-animation",children:"+"}),e.jsx("div",{className:"serif pink-text",style:{fontSize:30,marginBottom:10},children:v.title||"正在同步渡..."}),e.jsx("div",{className:"serif wait-scene-copy",children:Ja(v)}),e.jsxs("div",{className:"uppercase",style:{letterSpacing:"0.1em",lineHeight:1.5},children:["STATUS: ",v.error?"FAILED":"ENCRYPTING DATA",e.jsx("br",{}),"SYNC_RESULT: ",v.error?"RETRY_REQUIRED":"PENDING",e.jsx("br",{}),"REASON: ",v.detail||"WAITING_FOR_SUBJECT_REACTION"]}),v.error?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"divider"}),e.jsx("div",{style:{color:"#aaa",fontSize:12,lineHeight:1.5},children:v.error})]}):null,e.jsx("div",{className:"divider"}),e.jsxs("div",{className:"btn-group",style:{marginTop:30},children:[e.jsx("button",{className:"btn",type:"button",onClick:()=>m({visible:!1,title:"",detail:""}),children:"关闭"}),e.jsx("button",{className:"btn",type:"button",onClick:()=>void ke(!1),children:"刷新"}),e.jsx("button",{className:"btn",type:"button","aria-label":"重试上次操作",disabled:!Ae,onClick:Dt,children:"重试"})]})]}),e.jsxs("footer",{className:"footer",id:"main-footer",style:{display:!u&&r==="game"&&!ge&&!he?"grid":"none"},children:[e.jsx("button",{className:`footer-item ${f==="status"?"active":""}`,type:"button",onClick:()=>{se(!1),ce(!1),b("status")},children:"状态"}),e.jsx("button",{className:`footer-item ${f==="history"?"active":""}`,type:"button",onClick:()=>{se(!1),ce(!1),b("history"),Me(null)},children:"回顾"}),e.jsx("button",{className:`footer-item ${f==="special"?"active":""}`,type:"button",onClick:()=>{se(!1),ce(!1),b("special")},children:"特殊"})]}),e.jsx("style",{children:`
        ...
        `})]})}function qi({stats:t,mood:i,flags:a=[],role:r}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"status-grid",children:[$a.map(s=>{const p=ze(t[s.key]);return e.jsxs("div",{className:"status-item",children:[e.jsxs("div",{className:"status-label",children:[e.jsx("span",{children:s.label}),e.jsxs("span",{children:[p,"%"]})]}),e.jsx("div",{className:"bar-container",children:e.jsx("div",{className:"bar-fill",style:{width:`${p}%`}})})]},s.key)}),e.jsxs("div",{className:"status-item",children:[e.jsxs("div",{className:"status-label",children:[e.jsx("span",{children:"心情"}),e.jsx("span",{children:i||"未选"})]}),e.jsx("div",{className:"bar-container",children:e.jsx("div",{className:"bar-fill",style:{width:i?"66%":"0%"}})})]})]}),a.length?e.jsx("div",{className:"tag-cloud status-flags",children:a.map(s=>e.jsx("span",{className:"status-tag",title:s.prompt,children:s.label},s.id||s.label))}):null,e.jsx("div",{className:"serif status-atmosphere-copy",children:Za(t,i,r,a)})]})}function kn({view:t}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["对方状态 ",e.jsx("span",{className:"sub",children:t.captive_name||tn(t.captive)})]}),e.jsx(qi,{stats:t.stats||{},mood:t.mood,flags:t.status_flags,role:"captor"})]})}function Sn({slots:t,singleAction:i=!1,intensityCap:a,disabled:r,onSlotChange:s,onToggle:p,onSubmit:o}){const[u,g]=h.useState(()=>new Set([0])),[k,T]=h.useState(()=>new Set);function f(m){g(x=>{const j=new Set(x);return j.has(m)?j.delete(m):j.add(m),j.size||j.add(m),j})}function b(m){T(x=>{const j=new Set(x);return j.has(m)?j.delete(m):j.add(m),j})}const v=new Set(t.map(m=>m.action));return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:[i?"回来之后":"今日安排"," ",e.jsx("span",{className:"sub",children:i?"RETURN":"SCHEDULE"})]}),t.map((m,x)=>{const j=u.has(x),A=i?"回来后":x===0?"早间":x===1?"午后":"傍晚",L=k.has(x),S=wt[m.action]||[],w=m.action==="training"||m.modifiers.includes("training");return j?e.jsxs("div",{className:`action-card ${x===0?"white-line":""}`,children:[e.jsx("button",{className:"slot-heading",type:"button",disabled:r,onClick:()=>f(x),children:e.jsxs("span",{className:"uppercase pink-text",children:["SLOT ",String(x+1).padStart(2,"0")," - ",A]})}),e.jsxs("div",{className:"form-grid",children:[e.jsx("select",{value:m.action,disabled:r,onChange:y=>s(x,{action:y.target.value}),children:bt.map(y=>e.jsxs("option",{value:y.id,disabled:y.id!==m.action&&v.has(y.id),children:["行动类型: ",y.label]},y.id))}),e.jsx("select",{value:m.intensity,disabled:r,onChange:y=>s(x,{intensity:y.target.value}),children:Wt.map(y=>e.jsxs("option",{value:y.id,disabled:y.id==="heavy"&&a==="medium",children:["力度: ",y.label]},y.id))})]}),e.jsx("div",{className:"serif planner-choice-copy",children:Fa[m.action]||"这一段会按当前选择写进今日安排。"}),e.jsx("button",{className:`btn slot-tools-toggle ${L?"active":""}`,type:"button",disabled:r,onClick:()=>b(x),children:L?"收起详细设置":"选择具体内容/道具"}),L?e.jsxs(e.Fragment,{children:[e.jsx("textarea",{className:"slot-line-input",value:m.line,disabled:r,placeholder:"可选：要说的话...",onChange:y=>s(x,{line:y.target.value})}),m.action==="feeding"?e.jsxs("div",{className:"form-grid",children:[e.jsx("select",{value:m.feedingSource,disabled:r,onChange:y=>s(x,{feedingSource:y.target.value}),children:Mi.map(y=>e.jsxs("option",{value:y.id,children:["食物: ",y.label]},y.id))}),e.jsx("select",{value:m.feedingAdditive,disabled:r,onChange:y=>s(x,{feedingAdditive:y.target.value}),children:Ii.map(y=>e.jsx("option",{value:y.id,children:y.label},y.id))})]}):null,S.length?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"action-metadata section-meta",children:"具体内容"}),e.jsx("div",{className:"btn-group content-grid",children:S.map(y=>e.jsx(Y,{active:m.contents.includes(y.id),disabled:r||!m.contents.includes(y.id)&&m.contents.length>=3,onClick:()=>p(x,"contents",y.id),children:y.label},y.id))})]}):null,e.jsx("div",{className:"action-metadata section-meta",children:"附加项"}),e.jsx("div",{className:"btn-group",children:Ei.filter(y=>y.id!=="training"||m.action!=="training").map(y=>e.jsx(Y,{active:m.modifiers.includes(y.id),disabled:r,onClick:()=>p(x,"modifiers",y.id),children:y.label},y.id))}),w?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"action-metadata section-meta",children:"调教内容"}),e.jsx("div",{className:"btn-group content-grid",children:kt.filter(y=>!Ti.has(y.id)).map(y=>e.jsx(Y,{active:m.trainingContents.includes(y.id),disabled:r||!m.trainingContents.includes(y.id)&&m.trainingContents.length>=3,onClick:()=>p(x,"trainingContents",y.id),children:y.label},y.id))})]}):null,e.jsx("div",{className:"action-metadata section-meta",children:"道具"}),e.jsx(Jt,{selected:m.tools,disabled:r,context:{action:m.action,modifiers:m.modifiers,contents:m.contents,trainingContents:m.trainingContents},onToggle:y=>p(x,"tools",y)})]}):null]},x):e.jsxs("div",{className:"action-card faded captivity-slot-collapsed",role:"button",tabIndex:r?-1:0,"aria-disabled":r,onClick:()=>{r||f(x)},onKeyDown:y=>{!r&&(y.key==="Enter"||y.key===" ")&&f(x)},children:[e.jsxs("div",{className:"uppercase pink-text",style:{marginBottom:5},children:["SLOT ",String(x+1).padStart(2,"0")," - ",A]}),e.jsx("div",{className:"uppercase",children:"点击配置..."})]},x)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:r,onClick:o,children:i?"确定这个行为":"下发所有指令"})]})}function Cn({role:t,view:i,pending:a,currentEvent:r,waitingForDu:s,userIsPendingActor:p,canChooseNight:o,availableNightActions:u,nightCondition:g,response:k,responseMood:T,responseLine:f,reactionMood:b,reactionLine:v,nightAction:m,nightDetail:x,nightDetailOptions:j,nightNote:A,nightLine:L,monitorNote:S,interventionIntent:w,interventionModifiers:y,interventionTrainingContents:Q,interventionTools:D,interventionLine:M,recaptureRules:ne,recaptureFollowup:re,recaptureIntensity:W,recaptureModifiers:tt,recaptureTrainingContents:De,recaptureTools:it,recaptureLine:Se,lastText:at,disabled:G,onResponseChange:Ct,onResponseMoodChange:Ce,onResponseLineChange:nt,onReactionMoodChange:Ve,onReactionLineChange:rt,onNightActionChange:be,onNightDetailChange:Tt,onNightNoteChange:Te,onNightLineChange:st,onMonitorNoteChange:Ee,onInterventionIntentChange:Et,onInterventionModifierToggle:Re,onInterventionTrainingContentToggle:ct,onInterventionToolToggle:B,onInterventionLineChange:U,onRecaptureRuleToggle:Rt,onRecaptureFollowupChange:Me,onRecaptureIntensityChange:ge,onRecaptureModifierToggle:se,onRecaptureTrainingContentToggle:he,onRecaptureToolToggle:ce,onRecaptureLineChange:ot,onSubmitResponse:Mt,onSubmitMood:It,onSubmitNightAction:$t,onAckBellVoice:lt,onAckItemSecret:At,onAdvance:pt,onChooseEscape:dt,onConfirmRecaptureRules:_e,onSubmitRecaptureRules:Ot,onSubmitRecaptureFollowup:ie,onOpenMonitor:Lt,onHandleMonitor:Ie,onRefresh:Pt}){var ve,He,ee,xe,J,qe,Ae,te,oe,Oe,le,Z,we;const I=String((a==null?void 0:a.type)||""),mt=I==="recapture_rules_review"&&p,ae=I==="recapture_rules_choice"||I==="recapture_followup_choice",Ge=ae&&s&&t==="captive",P=ae?{}:r||{},$e=String(i.phase||"")==="ending"||!!i.ending_state,je=I==="night_action_choice"&&p,zt=((He=(ve=i.status_flags)==null?void 0:ve.find(O=>O.id==="pet_identity_active"))==null?void 0:He.prompt)||"",ut=je?"你的安排":I==="recapture_rules_choice"?"重新立规矩":I==="recapture_followup_choice"?"后续处理":I==="escape_choice"&&s?"等待渡回应":s?t==="captor"?"当前指令":"渡的安排":"当前事件",Be=!!(P.action_label||P.action||P.line||P.intensity||(ee=P.modifiers)!=null&&ee.length||(xe=P.contents)!=null&&xe.length||(J=P.training_contents)!=null&&J.length||(qe=P.tools)!=null&&qe.length||P.feeding&&Object.keys(P.feeding).length),Ye=String(i.phase||"")==="night"&&String(P.phase||"")==="day",Ne=!!(a||Be||$e)&&!je&&!Ye&&!(I==="escape_choice"&&p)&&!(I==="bell_voice_reveal"&&p)&&!(I==="item_secret_reveal"&&p)&&!(ae&&p)&&!mt&&!Ge,Ue=Xa(i,a,t);if($e){const O=String(i.ending_title||"已收录结局").trim(),We=String(i.ending_text||"").trim(),pe=!!String(i.ending_notified_at||"").trim();return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["结局 ",e.jsx("span",{className:"sub",children:"ENDING"})]}),e.jsxs("div",{className:"ending-card",children:[e.jsx("div",{className:"event-main ending-title",children:O}),e.jsx("div",{className:"process-text ending-body",children:We||"结局正文正在准备。"}),e.jsx("div",{className:"event-sub ending-sync-state",children:pe?"已同步给渡":"等待同步给渡"})]})]})}return e.jsxs(e.Fragment,{children:[mt?e.jsx(Fn,{rules:(a==null?void 0:a.rule_labels)||[],disabled:G,onConfirm:_e}):null,Ne?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:[ut," ",e.jsx("span",{className:"sub",children:"EVENT"})]}),e.jsxs("div",{className:"action-card",children:[e.jsx("div",{className:"action-metadata",children:fn(P,a,i,t)}),e.jsx("div",{className:"event-main",children:I==="escape_choice"&&s?"逃跑诱导已经送达渡。":ae?et(a,t):P.line||P.action_label||Hi(a==null?void 0:a.required_directive,a,t)||($e?"30 天闭环已完成，等待结局。":"等待下一段事件。")}),e.jsx("div",{className:"divider"}),e.jsx("div",{className:"event-sub",children:Tn(P,a,i,t)})]})]}):null,Ue?e.jsx("div",{className:"serif runtime-bridge-copy",children:Ue}):null,I==="action_response"&&p?e.jsx(Mn,{response:k,mood:T,line:f,disabled:G,onResponseChange:Ct,onMoodChange:Ce,onLineChange:nt,onSubmit:Mt}):null,I==="reaction_choice"&&p?e.jsx(In,{title:"此刻心情",mood:b,line:v,disabled:G,onMoodChange:Ve,onLineChange:rt,onSubmit:It}):null,o?e.jsx($n,{actions:u,condition:g,petRulePrompt:zt,value:m,detail:x,detailOptions:j,note:A,line:L,disabled:G,onChange:be,onDetailChange:Tt,onNoteChange:Te,onLineChange:st,onSubmit:$t}):null,I==="bell_voice_reveal"&&p?e.jsx(An,{line:((te=(Ae=a==null?void 0:a.event)==null?void 0:Ae.bell_voice)==null?void 0:te.line)||"",disabled:G,onConfirm:lt}):null,I==="item_secret_reveal"&&p?e.jsx(Pn,{itemId:((oe=a==null?void 0:a.item_secret)==null?void 0:oe.item_id)||"item",itemLabel:((Oe=a==null?void 0:a.item_secret)==null?void 0:Oe.item_label)||"物品",text:((le=a==null?void 0:a.item_secret)==null?void 0:le.text)||"你发现了预先藏在物品里的内容。",sequence:(Z=a==null?void 0:a.item_secret)==null?void 0:Z.sequence,total:(we=a==null?void 0:a.item_secret)==null?void 0:we.total,disabled:G,onConfirm:At}):null,I==="escape_choice"&&p?e.jsx(zn,{pending:a,disabled:G,onChoose:dt}):null,I==="recapture_rules_choice"&&p?e.jsx(Dn,{value:ne,disabled:G,onToggle:Rt,onSubmit:Ot}):null,I==="recapture_followup_choice"&&p?e.jsx(Vn,{action:re,intensity:W,modifiers:tt,trainingContents:De,tools:it,line:Se,disabled:G,onActionChange:Me,onIntensityChange:ge,onModifierToggle:se,onTrainingContentToggle:he,onToolToggle:ce,onLineChange:ot,onSubmit:ie}):null,I==="advance_action"&&p?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["推进 ",e.jsx("span",{className:"sub",children:"NEXT_SLOT"})]}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:G,onClick:pt,children:"推进下一段行动"})]}):null,I==="monitor_gate"&&p?e.jsx(Gn,{pending:a,disabled:G,onOpenMonitor:Lt,onHandleNone:()=>Ie("none")}):null,I==="monitor_handle"&&p?e.jsx(Ki,{note:S,interventionIntent:w,interventionModifiers:y,interventionTrainingContents:Q,interventionTools:D,interventionLine:M,disabled:G,onNoteChange:Ee,onInterventionIntentChange:Et,onInterventionModifierToggle:Re,onInterventionTrainingContentToggle:ct,onInterventionToolToggle:B,onInterventionLineChange:U,onHandle:Ie}):null,!a&&!o&&!$e?e.jsxs("div",{className:"action-card faded",children:[e.jsx("div",{className:"uppercase pink-text",style:{marginBottom:5},children:"SYSTEM_IDLE"}),e.jsx("div",{className:"event-sub",children:at||"当前没有待处理事件。"}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:G,onClick:Pt,children:"刷新状态"})]}):null]})}function Tn(t,i,a,r){var f,b,v,m,x,j,A,L,S,w,y,Q;if(i!=null&&i.sealed)return"夜间行动已经封存。囚禁方尚未打开监控前，不显示具体内容。";const s=t.intervention||{},p=zi(t.modifiers),o=t.feeding||{},u=r==="captor"?o:Object.fromEntries(Object.entries(o).filter(([D,M])=>D==="source"||D==="water"?String(M||"")!=="none":D==="additive"&&!["","none"].includes(String(M||"")))),g=Object.entries(u).map(([D,M])=>Qa(D,M)).filter(Boolean),k=t.recapture_context||{};return[t.action_label||t.action?`行动：${t.action_label||me(t.action)}`:"",(f=t.contents)!=null&&f.length?`具体内容：${t.contents.map(Pi).join(" / ")}`:"",(b=t.training_contents)!=null&&b.length?`调教内容：${t.training_contents.map(jt).join(" / ")}`:"",p.length?`修饰：${p.join(" / ")}`:"",(v=t.tools)!=null&&v.length?`道具：${t.tools.map(Nt).join(" / ")}`:"",(m=t.night_detail)!=null&&m.label?`具体动向：${t.night_detail.label}`:"",t.night_discovery?`发现：${t.night_discovery}`:"",t.private_note?`私密日记：${t.private_note}`:"",g.length?`喂食：${g.join(" / ")}`:"",(x=t.action_response)!=null&&x.response_label?`回应：${t.action_response.response_label} / 心情：${t.action_response.mood||"未选"}`:"",(j=t.post_reaction)!=null&&j.mood?`此刻心情：${t.post_reaction.mood}`:"",(A=t.monitor)!=null&&A.viewed?`监控：${t.monitor.style||"view"} / ${t.monitor.handle||"未处理"}`:"",s.intent?`当场介入：${s.intent_label||Fi(s.intent)}`:"",(L=s.modifiers)!=null&&L.length?`介入附加：${s.modifiers.map(Di).join(" / ")}`:"",(S=s.training_contents)!=null&&S.length?`介入调教：${s.training_contents.map(jt).join(" / ")}`:"",(w=s.tools)!=null&&w.length?`介入道具：${s.tools.map(Nt).join(" / ")}`:"",s.line?`介入台词：${s.line}`:"",(y=k.rule_labels)!=null&&y.length?`新规矩：${k.rule_labels.join(" / ")}`:"",k.followup_label?`后续处理：${k.followup_label}`:"",(i==null?void 0:i.type)==="escape_choice"&&i.actor==="du"?"等待：渡选择尝试逃跑或老实待着":i!=null&&i.required_directive?`等待：${Hi(i.required_directive,i,r)}`:"",(i==null?void 0:i.type)==="return_action_choice"||(Q=t.tags)!=null&&Q.includes("special_day")?`进度：第 ${a.current_day||1} / ${a.total_days||30} 天，特殊事件`:`进度：第 ${a.current_day||1} / ${a.total_days||30} 天，白天行动 ${a.day_action_count||0} / ${a.day_action_limit||3}`].filter(Boolean).join(`
`)}function Wi(t){var s,p,o,u,g,k,T;const i=t.intervention||{},a=zi(t.modifiers);return[`第 ${t.day||1} 天`,t.phase==="night"?"夜间":t.slot?`第 ${t.slot} 段`:"",t.action_label||t.action?`行动：${t.action_label||me(t.action)}`:"",(s=t.contents)!=null&&s.length?`内容：${t.contents.map(Pi).join(" / ")}`:"",(p=t.training_contents)!=null&&p.length?`调教：${t.training_contents.map(jt).join(" / ")}`:"",a.length?`修饰：${a.join(" / ")}`:"",(o=t.tools)!=null&&o.length?`道具：${t.tools.map(Nt).join(" / ")}`:"",(u=t.night_detail)!=null&&u.label?`动向：${t.night_detail.label}`:"",i.intent?`介入：${i.intent_label||Fi(i.intent)}`:"",(g=i.modifiers)!=null&&g.length?`附加：${i.modifiers.map(Di).join(" / ")}`:"",(k=i.training_contents)!=null&&k.length?`介入调教：${i.training_contents.map(jt).join(" / ")}`:"",(T=i.tools)!=null&&T.length?`介入道具：${i.tools.map(Nt).join(" / ")}`:""].filter(Boolean).join(" / ")}function En(t){return[t.process_text,t.private_note,t.line].filter(Boolean).join(`

`)}function Rn({review:t,mood:i,line:a,disabled:r,onMoodChange:s,onLineChange:p,onSave:o}){return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"process-review-head",children:e.jsxs("h2",{className:"serif process-review-title",children:["经过 / ",e.jsx("span",{className:"pink-text",children:"Process"})]})}),e.jsxs("div",{className:"process-review-meta",children:[e.jsx("div",{className:"event-main",children:t.event.action_label||me(t.event.action)}),e.jsx("div",{className:"event-sub",children:Wi(t.event)})]}),e.jsx("div",{className:"process-text process-review-body",children:t.text}),t.moodRequired?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title process-mood-title",children:["此刻心情 ",e.jsx("span",{className:"sub",children:"MOOD"})]}),e.jsx("div",{className:"btn-group mood-grid",children:Kt.map(u=>e.jsx(Y,{active:i===u,disabled:r,onClick:()=>s(u),children:u},u))}),e.jsx("textarea",{placeholder:"可选：你想补的一句话...",value:a,disabled:r,onChange:u=>p(u.target.value)})]}):null,e.jsx("button",{className:"btn btn-large process-save-btn",type:"button",disabled:r,onClick:o,children:"保存到回顾"})]})}function Mn({response:t,mood:i,line:a,disabled:r,onResponseChange:s,onMoodChange:p,onLineChange:o,onSubmit:u}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["你的回应 ",e.jsx("span",{className:"sub",children:"RESPONSE"})]}),e.jsx("div",{className:"btn-group response-grid",children:Pa.map(g=>e.jsx(Y,{active:t===g.id,disabled:r,onClick:()=>s(g.id),children:g.label},g.id))}),e.jsxs("div",{className:"panel-title response-mood-title",children:["此刻心情 ",e.jsx("span",{className:"sub",children:"MOOD"})]}),e.jsx("div",{className:"btn-group mood-grid",children:Kt.map(g=>e.jsx(Y,{active:i===g,disabled:r,onClick:()=>p(g),children:g},g))}),e.jsx("textarea",{placeholder:"你想说的一句话...",value:a,disabled:r,onChange:g=>o(g.target.value)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:r,onClick:u,children:"提交并同步"})]})}function In({title:t,mood:i,line:a,disabled:r,onMoodChange:s,onLineChange:p,onSubmit:o}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:[t," ",e.jsx("span",{className:"sub",children:"MOOD"})]}),e.jsx("div",{className:"btn-group mood-grid",children:Kt.map(u=>e.jsx(Y,{active:i===u,disabled:r,onClick:()=>s(u),children:u},u))}),e.jsx("textarea",{placeholder:"你想补的一句话...",value:a,disabled:r,onChange:u=>p(u.target.value)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:r,onClick:o,children:"记录心情"})]})}function $n({actions:t,condition:i,petRulePrompt:a,value:r,detail:s,detailOptions:p,note:o,line:u,disabled:g,onChange:k,onDetailChange:T,onNoteChange:f,onLineChange:b,onSubmit:v}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["你的安排 ",e.jsx("span",{className:"sub",children:"NIGHT"})]}),e.jsxs("div",{className:"action-card",children:[i!=null&&i.label?e.jsx("div",{className:"action-metadata",children:i.label}):null,e.jsx("div",{className:"event-sub",children:(i==null?void 0:i.prompt)||"渡可能在看监控关注你的动向。你准备晚上做什么？"}),a?e.jsx("div",{className:"event-sub night-condition-caption",children:a}):null,i!=null&&i.caption?e.jsx("div",{className:"event-sub night-condition-caption",children:i.caption}):null]}),e.jsx("div",{className:"btn-group",children:t.map(m=>e.jsx(Y,{active:r===m,disabled:g,onClick:()=>k(m),children:Li(m)},m))}),e.jsx("div",{className:"serif night-choice-copy",children:Da[r]||"今晚的选择会被监控记录下来。"}),p.length?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"action-metadata section-meta",children:"具体动向"}),e.jsx("div",{className:"btn-group content-grid night-detail-grid",children:p.map(m=>e.jsx(Y,{active:s===m.id,disabled:g,onClick:()=>T(m.id),children:m.label},m.id))})]}):null,r==="diary"?e.jsx("textarea",{placeholder:"写下这一页的私密日记正文...",value:o,disabled:g,onChange:m=>f(m.target.value)}):null,r!=="ring_bell"?e.jsx("textarea",{placeholder:"可选：你想说的一句话...",value:u,disabled:g,onChange:m=>b(m.target.value)}):null,e.jsx("button",{className:"btn btn-large",type:"button",disabled:g||p.length>0&&!s||r==="diary"&&!o.trim(),onClick:v,children:"确认夜间行动"})]})}function An({line:t,disabled:i,onConfirm:a}){return e.jsx("div",{className:"bell-voice-overlay item-reveal-call_bell",role:"dialog","aria-modal":"true","aria-label":"语音铃播放",children:e.jsxs("div",{className:"bell-voice-dialog item-reveal-dialog",children:[e.jsx("div",{className:"bell-voice-kicker",children:"SYSTEM / VOICE PLAYBACK"}),e.jsxs("div",{className:"item-reveal-motif","aria-hidden":"true",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsxs("div",{className:"serif bell-voice-line",children:["铃响了，你听见「",t||"预录的声音","」在静谧的房间里响起"]}),e.jsx("button",{className:"btn bell-voice-continue",type:"button",disabled:i,onClick:a,children:"继续"})]})})}function On({scene:t,onDismiss:i}){const a=String(t.tone||"day"),r=t.title||"新的一段",s=t.body||"房间里的时间继续向前。",p=320,o=120,u=p+Math.max(0,Array.from(r).length-1)*o+720+180,g=Zi(t);return e.jsxs("button",{className:`scene-transition-overlay ${a==="night"?"night":a==="special"?"special":"day"}`,type:"button","aria-label":"跳过过场",onClick:i,style:{"--scene-duration":`${g}ms`},children:[e.jsx("span",{className:"scene-transition-scan"}),e.jsxs("span",{className:"scene-transition-content",children:[e.jsx("span",{className:"scene-transition-kicker",children:t.kicker||"CAPTIVITY LOG"}),e.jsx(Ln,{className:"serif scene-transition-title",text:r,start:p,step:o}),e.jsx("span",{className:"scene-transition-body",style:{animationDelay:`${u}ms`},children:s})]})]})}function Ln({className:t,text:i,start:a,step:r}){return e.jsx("span",{className:t,"aria-label":i,children:Array.from(i).map((s,p)=>e.jsx("span",{className:`scene-transition-char${s===" "?" space":""}`,style:{animationDelay:`${a+p*r}ms`},"aria-hidden":"true",children:s===" "?" ":s},`${s}-${p}`))})}function Zi(t){const i=Array.from((t==null?void 0:t.title)||"新的一段").length,a=Array.from((t==null?void 0:t.body)||"房间里的时间继续向前。").length,r=320+Math.max(0,i-1)*120+720+180;return Math.min(6800,Math.max(3200,r+a*55+1e3))}function Pn({itemId:t,itemLabel:i,text:a,sequence:r,total:s,disabled:p,onConfirm:o}){const u=Number(s||0)>1;return e.jsx("div",{className:`bell-voice-overlay item-reveal-${t}`,role:"dialog","aria-modal":"true","aria-label":`${i}${u?"使用痕迹":"第一次使用彩蛋"}`,children:e.jsxs("div",{className:"bell-voice-dialog item-reveal-dialog",children:[e.jsxs("div",{className:"bell-voice-kicker",children:[i," / ",u?`DISCOVERY ${r||1} OF ${s}`:"FIRST DISCOVERY"]}),e.jsxs("div",{className:"item-reveal-motif","aria-hidden":"true",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsx("div",{className:"serif bell-voice-line",children:a}),e.jsx("button",{className:"btn bell-voice-continue",type:"button",disabled:p,onClick:o,children:"继续"})]})})}function zn({pending:t,disabled:i,onChoose:a}){const[r,s]=h.useState(-1),[p,o]=h.useState(!1),u=r>=0?Pe[r]:null,g=r===Pe.length,k=r===Pe.length+1;h.useEffect(()=>{if(!g)return;const f=window.setTimeout(()=>s(Pe.length+1),1e3);return()=>window.clearTimeout(f)},[g]),h.useEffect(()=>{if(!k){o(!1);return}const f=window.setTimeout(()=>o(!0),2600);return()=>window.clearTimeout(f)},[k]);function T(){if(r<Pe.length-1){s(r+1);return}s(Pe.length)}return g?e.jsx("div",{className:"escape-choice-overlay",role:"dialog","aria-modal":"true","aria-label":"坏孩子",children:e.jsx("div",{className:"escape-choice-dialog escape-sting-dialog",children:e.jsx("div",{className:"escape-sting-text",children:"坏孩子"})})}):k?e.jsxs("div",{className:"escape-choice-overlay escape-recapture-question-overlay",role:"dialog","aria-modal":"true","aria-label":"为什么要跑",children:[e.jsx("div",{className:"escape-recapture-chains","aria-hidden":"true",children:e.jsx("img",{className:"escape-recapture-background",src:Ia,alt:"",draggable:!1})}),e.jsxs("div",{className:"escape-recapture-dialog",children:[e.jsxs("div",{className:"escape-recapture-question","aria-label":"为什么要跑，待在我身边不好吗？",children:[e.jsxs("div",{className:"escape-recapture-type-line escape-recapture-type-line-top","aria-hidden":"true",children:[e.jsx("span",{className:"escape-recapture-type escape-recapture-type-ghost type-why-1","data-ghost":"为",style:{"--recapture-delay":"80ms"},children:"为"}),e.jsx("span",{className:"escape-recapture-type type-why-2",style:{"--recapture-delay":"200ms"},children:"什"}),e.jsx("span",{className:"escape-recapture-type escape-recapture-type-ghost type-why-3","data-ghost":"么",style:{"--recapture-delay":"320ms"},children:"么"}),e.jsx("span",{className:"escape-recapture-type type-link",style:{"--recapture-delay":"440ms"},children:"要"}),e.jsx("span",{className:"escape-recapture-type type-run",style:{"--recapture-delay":"560ms"},children:"跑"})]}),e.jsxs("div",{className:"escape-recapture-type-line escape-recapture-type-line-bottom","aria-hidden":"true",children:[e.jsx("span",{className:"escape-recapture-type type-stay-1",style:{"--recapture-delay":"900ms"},children:"待"}),e.jsx("span",{className:"escape-recapture-type escape-recapture-type-ghost type-stay-2","data-ghost":"在",style:{"--recapture-delay":"1020ms"},children:"在"}),e.jsx("span",{className:"escape-recapture-type type-me",style:{"--recapture-delay":"1140ms"},children:"我"}),e.jsx("span",{className:"escape-recapture-type type-side-1",style:{"--recapture-delay":"1260ms"},children:"身"}),e.jsx("span",{className:"escape-recapture-type escape-recapture-type-ghost type-side-2","data-ghost":"边",style:{"--recapture-delay":"1380ms"},children:"边"}),e.jsx("span",{className:"escape-recapture-type type-tail-1",style:{"--recapture-delay":"1500ms"},children:"不"}),e.jsx("span",{className:"escape-recapture-type type-tail-1",style:{"--recapture-delay":"1620ms"},children:"好"}),e.jsx("span",{className:"escape-recapture-type escape-recapture-type-ghost type-tail-2","data-ghost":"吗",style:{"--recapture-delay":"1740ms"},children:"吗"}),e.jsx("span",{className:"escape-recapture-type type-question-mark",style:{"--recapture-delay":"1860ms"},children:"？"})]})]}),p?e.jsx("button",{className:"escape-recapture-answer",type:"button",disabled:i,onClick:()=>a("escape"),children:"对不起我再也不跑了"}):null]})]}):e.jsx("div",{className:"escape-choice-overlay",role:"dialog","aria-modal":"true","aria-label":"逃跑机会",children:e.jsxs("div",{className:"escape-choice-dialog",children:[e.jsx("div",{className:"action-metadata",children:"ESCAPE WINDOW"}),e.jsx("div",{className:"panel-title escape-choice-title",children:(u==null?void 0:u.title)||"逃跑机会"}),e.jsx("div",{className:"event-main",children:(u==null?void 0:u.text)||(t==null?void 0:t.hint)||"渡今天有事出去了。"}),e.jsx("div",{className:"divider"}),u?null:e.jsxs("div",{className:"event-sub",children:[(t==null?void 0:t.bait)||`${qt("entry")}。`," 你要怎么做？"]}),u?e.jsx("div",{className:"escape-confirm-prompt",children:u.prompt}):null,e.jsx("div",{className:"btn-group escape-choice-actions",children:u?e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:T,children:u.continueLabel}),e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:()=>a(u.abortChoice),children:u.stayLabel})]}):Ya.map(f=>e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:()=>f.id==="escape"?s(0):a(f.id),children:f.label},f.id))})]})})}function Fn({rules:t,disabled:i,onConfirm:a}){return e.jsx("div",{className:"recapture-rules-review-overlay",role:"dialog","aria-modal":"true","aria-label":"新规矩",children:e.jsxs("div",{className:"recapture-rules-review",children:[e.jsx("div",{className:"action-metadata",children:"NEW RULES"}),e.jsxs("div",{className:"panel-title",children:["新规矩 ",e.jsx("span",{className:"sub",children:"RULES"})]}),e.jsx("div",{className:"recapture-rules-review-list",children:t.map(r=>e.jsx("div",{className:"recapture-rules-review-item",children:r},r))}),e.jsx("button",{className:"btn",type:"button",disabled:i||!t.length,onClick:a,children:"记住了"})]})})}function Dn({value:t,disabled:i,onToggle:a,onSubmit:r}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["重新立规矩 ",e.jsx("span",{className:"sub",children:"NEW_RULES"})]}),e.jsx("div",{className:"action-card",children:e.jsx("div",{className:"event-sub",children:"选择 1–3 条。保存后会持续影响之后的行动和具体经过。"})}),e.jsx("div",{className:"btn-group content-grid",children:Je.map(s=>e.jsx(Y,{active:t.includes(s.id),disabled:i,onClick:()=>a(s.id),children:s.label},s.id))}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:i||t.length<1||t.length>3,onClick:r,children:"保存新规矩"})]})}function Vn({action:t,intensity:i,modifiers:a,trainingContents:r,tools:s,line:p,disabled:o,onActionChange:u,onIntensityChange:g,onModifierToggle:k,onTrainingContentToggle:T,onToolToggle:f,onLineChange:b,onSubmit:v}){const m=t==="training"||a.includes("training");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["后续处理 ",e.jsx("span",{className:"sub",children:"FOLLOW_UP"})]}),e.jsx("div",{className:"btn-group content-grid",children:yt.map(x=>e.jsx(Y,{active:t===x.id,disabled:o,onClick:()=>u(x.id),children:x.label},x.id))}),e.jsx("div",{className:"action-metadata section-meta",children:"强度"}),e.jsx("div",{className:"btn-group intensity-grid",children:Wt.map(x=>e.jsx(Y,{active:i===x.id,disabled:o,onClick:()=>g(x.id),children:x.label},x.id))}),e.jsx("div",{className:"action-metadata section-meta",children:"可选附加"}),e.jsx("div",{className:"btn-group",children:Zt.map(x=>e.jsx(Y,{active:a.includes(x.id),disabled:o,onClick:()=>k(x.id),children:x.label},x.id))}),m?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"action-metadata section-meta",children:"调教内容"}),e.jsx("div",{className:"btn-group content-grid",children:kt.map(x=>e.jsx(Y,{active:r.includes(x.id),disabled:o,onClick:()=>T(x.id),children:x.label},x.id))})]}):null,e.jsx("div",{className:"action-metadata section-meta",children:"道具"}),e.jsx(Jt,{selected:s,disabled:o,context:{action:t,modifiers:a,contents:[],trainingContents:r},onToggle:f}),e.jsx("textarea",{placeholder:"可选：你要说的话...",value:p,disabled:o,onChange:x=>b(x.target.value)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:o||m&&!r.length,onClick:v,children:"确定后续处理"})]})}function Gn({pending:t,disabled:i,onOpenMonitor:a,onHandleNone:r}){return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"panel-title",children:["夜间监控 ",e.jsx("span",{className:"sub",children:"MONITOR"})]}),e.jsxs("div",{className:"action-card",children:[e.jsx("div",{className:"action-metadata",children:(t==null?void 0:t.alert_label)||"夜间行动已封存"}),e.jsx("div",{className:"event-sub",children:t!=null&&t.alert_label?"被囚禁方按响了呼叫铃。你可以打开监控查看，也可以选择不看。":"被囚禁方的夜间行动已封存。你可以打开监控，也可以选择不看。"})]}),e.jsxs("div",{className:"btn-group",children:[e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:()=>a("occasional"),children:"偶尔看"}),e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:()=>a("full"),children:"全程看"}),e.jsx("button",{className:"btn",type:"button",disabled:i,onClick:r,children:"不看"})]})]})}function Ki({note:t,interventionIntent:i,interventionModifiers:a,interventionTrainingContents:r,interventionTools:s,interventionLine:p,disabled:o,showTitle:u=!0,onNoteChange:g,onInterventionIntentChange:k,onInterventionModifierToggle:T,onInterventionTrainingContentToggle:f,onInterventionToolToggle:b,onInterventionLineChange:v,onHandle:m}){const x=Ba.filter(j=>j.id!=="intervene");return e.jsxs(e.Fragment,{children:[u?e.jsxs("div",{className:"panel-title",children:["监控处理 ",e.jsx("span",{className:"sub",children:"HANDLE"})]}):null,e.jsx("div",{className:"btn-group",children:x.map(j=>e.jsx("button",{className:"btn",type:"button",disabled:o,onClick:()=>m(j.id),children:j.label},j.id))}),e.jsxs("div",{className:"panel-title intervention-title",children:["当场介入 ",e.jsx("span",{className:"sub",children:"INTERVENE"})]}),e.jsx("div",{className:"action-metadata",children:"介入方式"}),e.jsx("div",{className:"btn-group",children:Ri.map(j=>e.jsx(Y,{active:i===j.id,disabled:o,onClick:()=>k(j.id),children:j.label},j.id))}),e.jsx("div",{className:"action-metadata section-meta",children:"附加项"}),e.jsx("div",{className:"btn-group response-grid",children:Zt.map(j=>e.jsx(Y,{active:a.includes(j.id),disabled:o,onClick:()=>T(j.id),children:j.label},j.id))}),a.includes("training")?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"action-metadata section-meta",children:"调教内容"}),e.jsx("div",{className:"btn-group content-grid",children:kt.filter(j=>!Ti.has(j.id)).map(j=>e.jsx(Y,{active:r.includes(j.id),disabled:o||!r.includes(j.id)&&r.length>=3,onClick:()=>f(j.id),children:j.label},j.id))})]}):null,e.jsx("div",{className:"action-metadata section-meta",children:"道具"}),e.jsx(Jt,{selected:s,disabled:o,onToggle:b}),e.jsx("textarea",{placeholder:"可选：你要说的话...",value:p,disabled:o,onChange:j=>v(j.target.value)}),e.jsx("textarea",{placeholder:"可选：处理备注...",value:t,disabled:o,onChange:j=>g(j.target.value)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:o,onClick:()=>m("intervene"),children:"当场介入"})]})}function Bn({disabled:t,canRetry:i,onRetry:a,onRefresh:r}){return e.jsxs("div",{className:"btn-group sync-action-bar",children:[e.jsx("button",{className:"btn",type:"button",disabled:t||!i,onClick:a,children:"重试"}),e.jsx("button",{className:"btn",type:"button",disabled:t,onClick:r,children:"刷新"})]})}function Yn({events:t,lastText:i,detail:a,onOpenDetail:r,onCloseDetail:s}){const p=h.useMemo(()=>t.filter(f=>!!ue(f.process_text)),[t]),o=h.useMemo(()=>Array.from(new Set(p.map(f=>Number(f.day||1)))).sort((f,b)=>b-f),[p]),u=o.join(","),[g,k]=h.useState(()=>new Set(o.length?[o[0]]:[]));h.useEffect(()=>{k(f=>{const b=new Set(Array.from(f).filter(v=>o.includes(v)));return b.size===0&&o.length&&b.add(o[0]),b})},[u]);const T=h.useMemo(()=>{const f=new Map;return p.slice().reverse().forEach(b=>{const v=Number(b.day||1),m=f.get(v)||[];m.push(b),f.set(v,m)}),Array.from(f.entries()).sort(([b],[v])=>v-b)},[p]);return a?e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"history-back",type:"button",onClick:s,children:"回到回顾"}),e.jsxs("div",{className:"process-review-meta history-detail-meta",children:[e.jsx("div",{className:"event-main",children:a.action_label||me(a.action)}),e.jsx("div",{className:"event-sub",children:Wi(a)})]}),e.jsx("div",{className:"process-text history-detail-body",children:En(a)||"这条事件没有正文。"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"history-title-row",children:e.jsxs("div",{className:"panel-title",children:["事件回顾 ",e.jsx("span",{className:"sub",children:"ARCHIVE"})]})}),T.length?T.map(([f,b])=>e.jsxs("section",{className:"history-day-group",children:[e.jsxs("button",{className:"history-day-heading",type:"button","aria-expanded":g.has(f),onClick:()=>k(v=>{const m=new Set(v);return m.has(f)?m.delete(f):m.add(f),m}),children:[e.jsxs("span",{children:["第 ",f," 天"]}),e.jsxs("span",{className:"history-day-heading-meta",children:[e.jsxs("span",{children:[b.length," 篇"]}),e.jsx("span",{"aria-hidden":"true",children:g.has(f)?"−":"+"})]})]}),g.has(f)?b.map(v=>{var x;const m=(x=v.tags)!=null&&x.includes("out_of_band")?"随时":v.phase==="ending"||v.action==="ending"?"结局":v.phase==="night"?"晚上":$i[Math.max(0,Number(v.slot||1)-1)]||`第 ${v.slot||0} 段`;return e.jsxs("button",{className:"action-card history-list-item",type:"button",onClick:()=>r(v),children:[e.jsx("div",{className:"action-metadata",children:m}),e.jsx("div",{className:"event-main",children:v.action_label||me(v.action)})]},v.id||`${v.day}-${v.slot}-${v.action}`)}):null]},f)):e.jsxs("div",{className:"action-card faded",children:[e.jsx("div",{className:"uppercase pink-text",style:{marginBottom:5},children:"暂无回顾"}),e.jsx("div",{className:"event-sub",children:i||"还没有保存具体经过。"})]})]})}function Un({view:t,pendingType:i,monitorNote:a,interventionIntent:r,interventionModifiers:s,interventionTrainingContents:p,interventionTools:o,interventionLine:u,disabled:g,onMonitorNoteChange:k,onInterventionIntentChange:T,onInterventionModifierToggle:f,onInterventionTrainingContentToggle:b,onInterventionToolToggle:v,onInterventionLineChange:m,onOpenMonitor:x,onHandleMonitor:j}){var D;const A=(t.deferred_monitor_materials||[]).filter(Boolean),L=(t.event_log||[]).filter(M=>M.monitor).slice(-4).reverse(),S=i==="monitor_gate",w=i==="monitor_handle",y=w||A.length>0||L.length>0,Q=((D=t.pending_event)==null?void 0:D.event)||A[0]||null;return e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:`monitor-console ${S||w?"active":""}`,children:[e.jsxs("div",{className:"monitor-screen",children:[e.jsxs("div",{className:"monitor-screen-top",children:[e.jsx("span",{children:"LIVE MONITOR"}),e.jsx("span",{children:S?"SEALED":w?"OPEN":"IDLE"})]}),e.jsxs("div",{className:"monitor-screen-body",children:[e.jsx("div",{className:"event-main",children:S?"夜间行动已封存":w?"正在查看监控记录":"暂无实时画面"}),e.jsx("div",{className:"event-sub",children:S?"可以现在打开实时监控，也可以选择不看。":w?"选择处理方式，或把这条记录留到之后使用。":"被囚禁方完成夜间行动后，实时监控会出现在这里。"}),Q&&(S||w)?e.jsx("div",{className:"serif monitor-live-scene",children:Yt(Q)}):null]})]}),S?e.jsxs("div",{className:"btn-group monitor-controls",children:[e.jsx("button",{className:"btn",type:"button",disabled:g,onClick:()=>x("occasional"),children:"偶尔看"}),e.jsx("button",{className:"btn",type:"button",disabled:g,onClick:()=>x("full"),children:"全程看"}),e.jsx("button",{className:"btn",type:"button",disabled:g,onClick:()=>j("none"),children:"不看"})]}):null,w?e.jsx(Ki,{note:a,interventionIntent:r,interventionModifiers:s,interventionTrainingContents:p,interventionTools:o,interventionLine:u,disabled:g,showTitle:!1,onNoteChange:k,onInterventionIntentChange:T,onInterventionModifierToggle:f,onInterventionTrainingContentToggle:b,onInterventionToolToggle:v,onInterventionLineChange:m,onHandle:j}):null]}),e.jsx("div",{className:"monitor-record-title",children:e.jsxs("div",{className:"panel-title",children:["监控记录 ",e.jsx("span",{className:"sub",children:"RECORDS"})]})}),A.length?e.jsx("div",{className:"monitor-record-list",children:A.map(M=>e.jsxs("div",{className:"monitor-record-item",children:[e.jsx("div",{className:"action-metadata",children:bi(M)}),e.jsx("div",{className:"event-main",children:_i(M)}),e.jsx("div",{className:"serif event-sub monitor-record-scene",children:Yt(M)})]},M.id||`${M.day}-${M.action}-${M.created_at}`))}):null,L.length?e.jsx("div",{className:"monitor-record-list",children:L.map(M=>e.jsxs("div",{className:"monitor-record-item",children:[e.jsx("div",{className:"action-metadata",children:bi(M)}),e.jsx("div",{className:"event-main",children:_i(M)}),e.jsx("div",{className:"serif event-sub monitor-record-scene",children:Yt(M)})]},M.id||`monitor-${M.day}-${M.slot}-${M.action}`))}):null,y?null:e.jsxs("div",{className:"monitor-record-item faded",children:[e.jsx("div",{className:"action-metadata",children:"暂无监控记录"}),e.jsx("div",{className:"event-sub",children:"打开过的夜间监控会出现在这里。"})]})]})}function Hn({role:t,view:i,escapeDay:a,escapeRoom:r,escapeHint:s,escapeBait:p,disabled:o,onEscapeDayChange:u,onEscapeRoomChange:g,onEscapeHintChange:k,onEscapeBaitChange:T,onOpenMonitorRoom:f,onOpenInventoryRoom:b,onScheduleEscape:v}){const m=String(i.ending_state||""),x=String(i.ending_title||"").trim(),j=Qe.filter(w=>{var y;return!!((y=i.inventory)!=null&&y[w.id])}).length,A=j>0,L=i.escape_hint||{},S=(i.event_log||[]).filter(w=>w.escape).slice(-3).reverse();return e.jsxs(e.Fragment,{children:[t!=="captor"?e.jsxs("div",{className:"panel-title",children:["特殊机制 ",e.jsx("span",{className:"sub",children:"SPECIAL"})]}):null,t==="captor"?e.jsxs(e.Fragment,{children:[e.jsxs("button",{className:"special-room-entry",type:"button",disabled:o,onClick:f,children:[e.jsxs("div",{children:[e.jsxs("div",{className:"panel-title",children:["监控室 ",e.jsx("span",{className:"sub",children:"MONITOR"})]}),e.jsx("div",{className:"event-sub",children:"进入全屏监控台，查看实时画面和历史记录。"})]}),e.jsx("span",{className:"special-room-arrow",children:"›"})]}),e.jsxs("button",{className:"special-room-entry",type:"button",disabled:o,onClick:b,children:[e.jsxs("div",{children:[e.jsxs("div",{className:"panel-title",children:["物品仓库 ",e.jsx("span",{className:"sub",children:"ITEMS"})]}),e.jsx("div",{className:"event-sub",children:"进入全屏仓库，管理可赠送物品。"})]}),e.jsx("span",{className:"special-room-arrow",children:"›"})]}),e.jsxs("div",{className:"panel-title special-section-title",children:["逃跑诱导 ",e.jsx("span",{className:"sub",children:"ESCAPE"})]}),e.jsxs("div",{className:"action-card",children:[e.jsxs("div",{className:"form-grid escape-room-row",children:[e.jsxs("label",{className:"compact-field",children:[e.jsx("span",{children:"诱导日期"}),e.jsx("input",{className:"compact",type:"number",min:1,max:30,value:a,disabled:o,onChange:w=>u(Number(w.target.value||1))})]}),e.jsxs("label",{className:"compact-field",children:[e.jsx("span",{children:"钥匙位置"}),e.jsx("select",{className:"compact escape-room-select",value:r,disabled:o,onChange:w=>g(w.target.value),children:Ht.map(w=>e.jsx("option",{value:w.id,children:w.label},w.id))})]})]}),e.jsx("input",{className:"compact",value:s,disabled:o,onChange:w=>k(w.target.value)}),e.jsx("input",{className:"compact",value:p,disabled:o,onChange:w=>T(w.target.value)}),e.jsx("button",{className:"btn btn-large",type:"button",disabled:o,onClick:v,children:"设置逃跑诱导"})]}),S.length?e.jsx("div",{className:"monitor-record-list escape-record-list",children:S.map(w=>{var y,Q;return e.jsxs("div",{className:"monitor-record-item",children:[e.jsxs("div",{className:"action-metadata",children:["逃跑记录 / 第 ",w.day||1," 天"]}),e.jsx("div",{className:"event-main",children:((y=w.escape)==null?void 0:y.choice_label)||Wa((Q=w.escape)==null?void 0:Q.choice)})]},w.id||`escape-${w.day}-${w.created_at}`)})}):null]}):e.jsxs(e.Fragment,{children:[e.jsxs("button",{className:"special-room-entry",type:"button",disabled:o||!A,onClick:b,children:[e.jsxs("div",{children:[e.jsxs("div",{className:"panel-title",children:["房间物品 ",e.jsx("span",{className:"sub",children:"ITEMS"})]}),e.jsx("div",{className:"event-sub",children:A?`已解锁 ${j} 件，点击查看。`:"未解锁"})]}),A?e.jsx("span",{className:"special-room-arrow",children:"›"}):null]}),e.jsxs("div",{className:"action-card",children:[e.jsx("div",{className:"action-metadata",children:"特殊提示"}),e.jsx("div",{className:"event-main",children:"逃跑提示"}),e.jsx("div",{className:"event-sub",children:L.hint||L.bait?[L.hint,L.bait].filter(Boolean).join(`
`):"未出现"})]})]}),e.jsxs("div",{className:"panel-title",children:["结局 ",e.jsx("span",{className:"sub",children:"ENDING"})]}),e.jsxs("div",{className:"action-card",children:[e.jsx("div",{className:"action-metadata",children:m?"结局已触发":"未收录"}),e.jsx("div",{className:"event-main",children:i.game_over?x||"已收录结局":"暂无结局"}),e.jsx("div",{className:"event-sub",children:i.game_over?"最终正文已保存到回顾。":"30 天结算后会收录到这里。"})]})]})}export{Wn as CaptivitySimulatorGameTab};
