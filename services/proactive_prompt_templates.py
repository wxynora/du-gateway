...
可以选：给她发消息、暂时不打扰、去写日记/记事、逛论坛、上网冲浪找点可聊话题、整理秘密抽屉/随机翻旧条目，或其它你认为合适的动作。
...
{"action":"send_message|no_contact|diary|forum|surf|drawer|other","reason":"简短原因","message":"send_message 时要发的话，其它可空","channel":"{{default_channel}}"}"""
