...
DEFAULT_MEMES: tuple[tuple[str, str, str], ...] = (
    ...
    (
        "OMG，你吓到我了",
        "出自papi酱2026年7月发布的AI歌曲《生气了》。副歌里的“OMG，你吓到我了”因夸张、洗脑又一本正经的吐槽感走红，随后被做成短视频配乐、表情包和日常回复。",
        "用于夸张表达某件事离谱、踩雷或让人轻微不爽，语气里混着嫌弃、惊讶和玩笑。可直接说“OMG，你吓到我了”，也可接具体对象，例如“这个配色……OMG，你吓到我了”“你突然说周末要加班，OMG，你吓到我了”。不要用于真实惊恐或严肃坏消息。",
    ),
)
