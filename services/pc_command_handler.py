...
from services.draft_block import compute_visible_streaming as compute_draft_visible_streaming
...
from services.listen_invite_flow import compute_visible_streaming as compute_listen_invite_visible_streaming
...
class PcmdDuThoughtStreamState:
    ...
    def feed_delta(self, delta_piece: str) -> str:
        ...
        visible = compute_draft_visible_streaming(after_pcmd)
        visible = compute_visible_streaming(visible)
