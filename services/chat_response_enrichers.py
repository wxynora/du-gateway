...
def merge_html_preview_into_nonstream_response(resp_json: dict, messages: list) -> dict:
...
def html_preview_suffix_for_stream(assistant_text: str, messages: list) -> str:
    return missing_html_preview_url_suffix(assistant_text, messages)
