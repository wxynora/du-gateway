...
export function resolveChatFontFamily(fontKey: ChatFontKey): string {
  ...
  if (fontKey === "kuaile") return "'SumiZcoolKuaiLe', 'PingFang SC', 'Microsoft YaHei', 'Noto Sans SC', sans-serif";
  if (fontKey === "huninn") return "'LXGW WenKai Screen', 'PingFang SC', 'Microsoft YaHei', 'Noto Sans SC', sans-serif";
