...
export function CornerDownIcon() {
...
export function PhoneIconLarge({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
...
export function PhoneIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.34 1.78.65 2.62a2 2 0 0 1-.45 2.11L8 9.91a16 16 0 0 0 6 6l1.46-1.31a2 2 0 0 1 2.11-.45c.84.31 1.72.53 2.62.65A2 2 0 0 1 22 16.92z" /></svg>;
}

export function SmileIconMini({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
...
export function RouteIconMini({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="19" r="2" /><circle cx="18" cy="5" r="2" /><path d="M8 19h3a3 3 0 0 0 0-6H9a3 3 0 0 1 0-6h7" /></svg>;
}

export function ImageIconMini({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="3" /><circle cx="8.5" cy="9.5" r="1.5" /><path d="m21 15-4.5-4.5L9 18" /><path d="m12 15 2-2 5 5" /></svg>;
}

export function BrushIconMini({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.06 11.9 18.4 2.56a2.1 2.1 0 0 1 2.98 2.98l-9.34 9.34" /><path d="M7 14c-2.7.5-4 2.1-4 5 2.9 0 4.5-1.3 5-4" /><path d="M8 13.2 10.8 16" /></svg>;
}

export function MicIconMini({ className = "h-7 w-7 stroke-[1.5]" }: { className?: string } = {}) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a3 3 0 0 0-3 3v6a3 3 0 0 0 6 0V6a3 3 0 0 0-3-3Z" /><path d="M19 11a7 7 0 0 1-14 0" /><path d="M12 18v3" /><path d="M8 21h8" /></svg>;
}

export function KeyboardIconMini({ className = "h-5 w-5 stroke-[1.8]" }: { className?: string } = {}) {
  return <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M7 9h.01M11 9h.01M15 9h.01M17 13h.01M13 13h.01M9 13h.01M7 17h10" /></svg>;
}
...
export function MoonIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401Z" /><path d="M16 8h.01" /><path d="M12 5h.01" /></svg>;
}

export function HeartIconMini() {
...
export function HeadphonesIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3" /></svg>;
}

export function HomeIconMini() {
...
export function SearchIconMini() {
...
export function SettingsIconMini() {
...
export function CalendarIconMini() {
...
export function FileTextIcon({ className = "h-5 w-5 stroke-[1.5]" }: { className?: string } = {}) {
...
export function CabinetFilingIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 12h16" /><rect width="16" height="20" x="4" y="2" rx="2" /><path d="M10 6h4" /><path d="M10 16h4" /></svg>;
}

export function CloudUploadIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 13v8" /><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" /><path d="m8 17 4-4 4 4" /></svg>;
}
...
export function GraduationCapIconMini() {
...
export function NotebookPenIconMini() {
...
export function UserRoundCogIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m14.305 19.53.923-.382" /><path d="m15.228 16.852-.923-.383" /><path d="m16.852 15.228-.383-.923" /><path d="m16.852 20.772-.383.924" /><path d="m19.148 15.228.383-.923" /><path d="m19.53 21.696-.382-.924" /><path d="M2 21a8 8 0 0 1 10.434-7.62" /><path d="m20.772 16.852.924-.383" /><path d="m20.772 19.148.924.383" /><circle cx="10" cy="8" r="5" /><circle cx="18" cy="18" r="3" /></svg>;
}
...
export function SmartphoneIconMini() {
...
export function SpeakerIconMini() {
  return <svg className="h-5 w-5 stroke-[1.5]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" /><path d="M12 6h.01" /><circle cx="12" cy="14" r="4" /><path d="M12 14h.01" /></svg>;
}

export function LogoutIconMini() {
