...
export function sweepNonces(now) {
...
export function htmlDesignForm(playKey, o) {
    const lack = o.coins < o.fee;
    const fld = (name, label, hint, max, area, required, ph) => `<label style="display:block;margin:14px 0">
...
export function htmlGenLink(action, url, ai) {
...
export function htmlNotice(text, href, linkLabel) {
...
export function htmlAgentPage(playKey, statusText, links, banner) {
