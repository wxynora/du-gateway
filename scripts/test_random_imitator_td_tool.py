...
def test_game_checkpoint_finalization_preserves_tools_without_message_injection() -> None:
    result = json.dumps(
        {
            "ok": True,
            "game_id": "future_game",
    ...
    _assert(body.get("tools"), "checkpoint finalization should keep tools for prompt cache stability")
    _assert(body.get("tool_choice") == "auto", "checkpoint finalization should keep tool_choice")
...
if __name__ == "__main__":
    ...
    test_game_checkpoint_finalization_preserves_tools_without_message_injection()
