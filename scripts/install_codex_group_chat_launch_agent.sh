...
CODEX_GROUP_CHAT_CLAIM_WAIT_SECONDS=${CODEX_GROUP_CHAT_CLAIM_WAIT_SECONDS:-20}
CODEX_GROUP_CHAT_CLAIM_TIMEOUT_SECONDS=${CODEX_GROUP_CHAT_CLAIM_TIMEOUT_SECONDS:-25}
