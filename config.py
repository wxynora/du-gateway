...
WATCH_ANALYSIS_PROMPT_VERSION = os.environ.get("WATCH_ANALYSIS_PROMPT_VERSION", "watch-v8").strip() or "watch-v8"
WATCH_ANALYSIS_TIMEOUT_SECONDS = _env_int("WATCH_ANALYSIS_TIMEOUT_SECONDS", 120, 20, 600)
WATCH_ANALYSIS_MAX_OUTPUT_TOKENS = _env_int("WATCH_ANALYSIS_MAX_OUTPUT_TOKENS", 3200, 600, 12000)
