...
TOOL_RESULT_CACHE_MAX_TOKENS = _env_int("TOOL_RESULT_CACHE_MAX_TOKENS", 5000, 200, 20000)
TOOL_RESULT_CACHE_TRIM_TO_TOKENS = _env_int("TOOL_RESULT_CACHE_TRIM_TO_TOKENS", 3500, 100, 19000)
if TOOL_RESULT_CACHE_TRIM_TO_TOKENS >= TOOL_RESULT_CACHE_MAX_TOKENS:
    TOOL_RESULT_CACHE_TRIM_TO_TOKENS = max(100, int(TOOL_RESULT_CACHE_MAX_TOKENS * 0.7))
