...
def _resolve_watch_analysis_api_key() -> str:
    explicit = os.environ.get("WATCH_ANALYSIS_API_KEY", "").strip()
    return explicit or resolve_openrouter_api_key()
...
WATCH_ANALYSIS_API_KEY = _resolve_watch_analysis_api_key()
WATCH_ANALYSIS_MODEL = os.environ.get(
    "WATCH_ANALYSIS_MODEL",
    "google/gemini-2.5-flash",
).strip()
WATCH_ANALYSIS_PROMPT_VERSION = os.environ.get("WATCH_ANALYSIS_PROMPT_VERSION", "watch-v2").strip() or "watch-v2"
...
WATCH_ANALYSIS_MAX_FRAMES_PER_JOB = _env_int("WATCH_ANALYSIS_MAX_FRAMES_PER_JOB", 8, 1, 16)
...
WATCH_ANALYSIS_RECOGNIZED_INTERVAL_MS = _env_int("WATCH_ANALYSIS_RECOGNIZED_INTERVAL_MS", 12_000, 3_000, 60_000)
WATCH_ANALYSIS_UNKNOWN_INTERVAL_MS = _env_int("WATCH_ANALYSIS_UNKNOWN_INTERVAL_MS", 6_000, 2_000, 30_000)
