...
_WAKEUP_QUEUE_DB_STR = os.environ.get("WAKEUP_QUEUE_DB", "").strip()
WAKEUP_QUEUE_DB = (
    Path(_WAKEUP_QUEUE_DB_STR)
    if _WAKEUP_QUEUE_DB_STR
    else DATA_DIR / "wakeup_queue.sqlite3"
)
if not WAKEUP_QUEUE_DB.is_absolute():
    WAKEUP_QUEUE_DB = BASE_DIR / WAKEUP_QUEUE_DB
...
WAKEUP_QUEUE_DONE_TTL_DAYS = int(os.environ.get("WAKEUP_QUEUE_DONE_TTL_DAYS", "1") or "1")
WAKEUP_QUEUE_KEEP_MAX = int(os.environ.get("WAKEUP_QUEUE_KEEP_MAX", "80") or "80")
WAKEUP_QUEUE_CLAIM_STALE_SECONDS = int(os.environ.get("WAKEUP_QUEUE_CLAIM_STALE_SECONDS", "600") or "600")
