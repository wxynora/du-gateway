...
WATCH_ANALYSIS_FORWARD_WINDOW_MS = _env_int("WATCH_ANALYSIS_FORWARD_WINDOW_MS", 300_000, 60_000, 900_000)
...
WATCH_ANALYSIS_MAX_JOBS_PER_SESSION = _env_int("WATCH_ANALYSIS_MAX_JOBS_PER_SESSION", 240, 10, 2000)
WATCH_ANALYSIS_DAILY_MAX_COST_USD = _env_float("WATCH_ANALYSIS_DAILY_MAX_COST_USD", 3.0, 0.0, 1000.0)
...
WATCH_KNOWLEDGE_MAX_OUTPUT_TOKENS = _env_int("WATCH_KNOWLEDGE_MAX_OUTPUT_TOKENS", 2400, 800, 6000)
